...
- **projectRootAbsolutePath**: `/Users/ricknini/Downloads/helmv3`
- **projectConfigAbsolutePath**: `/Users/ricknini/Downloads/helmv3/momentic.qualifier-hell.config.yaml`
...
One of: CLICK, TYPE, PRESS, SELECT_OPTION, DRAG, NAVIGATE, SCROLL, WAIT, AI_ASSERTION, HOVER, BLUR, GO_BACK, GO_FORWARD, REFRESH, NEW_TAB, CLOSE_TAB, SWITCH_TAB, WAIT_FOR_URL, COPY, PASTE, ELEMENT_CHECK, PAGE_CHECK, AI_EXTRACT, COOKIE, LOCAL_STORAGE, REQUEST, GRAPHQL_REQUEST, JAVASCRIPT, SET_HEADER, MOCK_ROUTE, REMOVE_ROUTE_MOCK, FILE_UPLOAD, DIALOG, MOUSE_DRAG, MODULE, AI_ACTION_DYNAMIC, CONDITIONAL.
...
**Example:** `--step-type JAVASCRIPT --code "return Math.floor(Math.random() * 100000)" --environment NODE --env-key RANDOM_NUMBER`
