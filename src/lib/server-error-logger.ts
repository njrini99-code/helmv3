...
interface RoundErrorContext {
   ...
   * — threshold starvation, skipped-record counters, philosophy-gate filters,
   * handled-degradation fallbacks — that should stay discoverable in the admin
   * feed and console without creating Sentry issues that drown out real bugs.
   */
  skipSentry?: boolean;
}
