...
export function RoundCompletionSummary({ summary, onClose }: RoundCompletionSummaryProps) {
  ...
  const getToParColor = (toPar: number) => {
    if (toPar <= -5) return 'text-primary-700';
  ...
  return (
    <div className="fixed inset-0 bg-warm-900/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="relative glass-standard rounded-2xl overflow-hidden shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto transition-all duration-300">
        ...
        />
        {/* Header */}
        <div className="bg-gradient-to-br from-primary-600 to-primary-700 text-white px-8 py-6 rounded-t-2xl">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-primary-100 text-sm">Great job out there</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-8 py-6 border-b border-warm-200">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="relative flex-1 text-center glass-standard rounded-xl overflow-hidden p-3 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
              ...
              />
              <p className="text-2xl font-bold text-primary-700">{summary.birdies}</p>
              <p className="text-xs font-medium text-primary-600 uppercase tracking-wide mt-1">Birdies</p>
            </div>
            <div className="relative flex-1 text-center glass-standard rounded-xl overflow-hidden p-3 transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5">
              {/* Shine effect */}
              <div
        ...
        <div className="px-8 py-6 bg-warm-50 rounded-b-2xl">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-700 hover:to-primary-800 text-white font-semibold py-4 px-6 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2"
          >
