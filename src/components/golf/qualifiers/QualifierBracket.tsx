      ...
      <div className="mt-6 pt-4 border-t border-warm-100">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div className="p-3 bg-primary-50 rounded-xl">
            <p className="text-h1 md:text-h1 font-light text-primary-700 tracking-[-0.025em]">
              {leaderboard.filter((_, i) => i < effectiveCutline).length}
            </p>
            <p className="text-xs text-warm-500 mt-1">Qualifying</p>
          </div>
          <div className="p-3 bg-amber-50 rounded-xl">
            <p className="text-h1 md:text-h1 font-light text-amber-700 tracking-[-0.025em]">
          ...
          <div className="p-3 bg-warm-50 rounded-xl">
            <p className="text-h1 md:text-h1 font-light text-warm-700 tracking-[-0.025em]">
              {leaderboard.length}
            </p>
