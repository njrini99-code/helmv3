            ...
            <div className="flex items-baseline gap-2 min-w-0">
              <span
                className={cn(
                  ...
                  'text-display md:text-display tracking-[-0.025em] font-medium',
          ...
          <Reveal staggerIndex={1}>
            <div className="mb-7 grid grid-cols-2 md:grid-cols-5 gap-2">
              <StatTile
                ...
                value={
                  <AnimatedNumber
                    ...
                    decimals={0}
                    staggerIndex={0}
                    className="text-h1 md:text-h1 font-light text-warm-900 tabular-nums tracking-[-0.025em]"
                  />
                }
              />
              <StatTile
              ...
              <StatTile
                ...
                value={
                  <span className="text-h1 md:text-h1 font-light text-warm-900 tabular-nums tracking-[-0.025em]">
