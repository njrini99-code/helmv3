      ...
      {[1, 2, 3, 4, 5].map((star) => (
        ...
        >
          <svg
            ...
            strokeWidth="1.5"
            className={cn(
              value && star <= value ? 'text-amber-400' : 'text-gray-300'
            )}
          >
            <path
              strokeLinecap="round"
...
export function RoundReviewPanel({
      ...
      <div className="bg-white border border-border-light rounded-xl p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="mt-4 w-full max-w-xs">
            ...
            <p className="mt-1 text-xs text-gray-400">{generationProgress}% complete</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Metadata */}
      <div className="flex items-center justify-between pt-4 border-t border-border-light text-xs text-gray-400">
