        ...
        <div className="px-6 py-5 space-y-5">
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
            <div className="flex-1">
              <p className="text-sm font-semibold text-slate-900">Mark as excused</p>
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div
                className={cn(
                  ...
                  isExcused ? 'bg-green-600' : 'bg-slate-300'
                )}
              >
                <div
                  className={cn(
          ...
          <div>
            ...
            <Textarea
              ...
              maxLength={500}
            />
            <p className="text-xs text-slate-500 mt-1.5">{notes.length}/500 characters</p>
          </div>
...
export function QuickAbsenceReason({
  ...
  return (
    <div className={cn('p-4 bg-slate-50 rounded-xl space-y-3', className)}>
      <p className="text-sm font-semibold text-slate-700">Quick absence reason</p>
        ...
        {ABSENCE_REASONS.slice(0, 4).map((reason) => {
          ...
          return (
            <button
              ...
              className="flex flex-col items-center gap-1.5 p-2.5 bg-white rounded-lg border border-slate-200 hover:border-slate-300 hover:shadow-sm transition-all"
            >
