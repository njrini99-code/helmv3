      ...
      >
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-border-subtle bg-surface-tint rounded-b-2xl">
          ...
          <Button variant="primary"
            ...
            className="px-4 py-2 bg-accent-750 hover:bg-accent-800 text-text-on-accent font-medium rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {uploading ? (
              <>
