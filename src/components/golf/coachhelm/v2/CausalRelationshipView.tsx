...
export function CausalRelationshipView({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 via-white to-green-50 border border-slate-200 rounded-xl p-6">
      ...
      <div className="border border-slate-200 rounded-xl p-4">
        ...
        <p className="text-sm text-slate-700">{relationship.mechanism}</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-600">Effect Strength</span>
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-600">Causal Confidence</span>
            <span className="text-lg font-semibold text-slate-900">
              {Math.round(relationship.confidence * 100)}%
            </span>
          </div>
      ...
      {/* Evidence indicators */}
      <div>
        <h4 className="text-sm font-medium text-slate-900 mb-3">Evidence Quality</h4>
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-2">
            ...
            <h4 className="text-sm font-medium text-slate-900">Intervention Potential</h4>
          </div>
      ...
      {relationship.temporalLagDays !== undefined && (
        <div className="flex items-center gap-3 p-3 bg-slate-50 border border-slate-200 rounded-lg">
          <IconClock size={18} className="text-slate-500" />
          <div>
  ...
  return (
    ...
    >
      {confirmed ? (
        ...
        <IconX size={16} className="text-slate-400 mt-0.5 flex-shrink-0" />
      )}
      <div>
        <p
          className={cn(
            'text-sm font-medium',
            confirmed ? 'text-green-700' : 'text-slate-600'
          )}
        >
          {label}
        </p>
