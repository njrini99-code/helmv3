              ...
              <div className="px-4 pb-4 pt-0">
                ...
                {playerId && (
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 mb-4 bg-white/70 hover:bg-white rounded-lg border border-slate-200 hover:border-green-200 transition-all group"
                  >
