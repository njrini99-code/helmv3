          ...
          <AnimatePresence mode="wait">
            {activeTab === 'overview' && (
              ...
              >
                {/* Full body */}
                <div>
                  <h3 className="text-sm font-medium text-slate-900 mb-2">Analysis</h3>
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="bg-slate-50 rounded-lg p-3 text-center">
                    ...
                    <p className="text-xs text-slate-500 mt-1">Reasoning Steps</p>
                  </div>
                  <div className="bg-slate-50 rounded-lg p-3 text-center">
                    <p className="text-2xl font-semibold text-slate-900">
                      {insight.reasoning?.alternatives?.length || 0}
                    </p>
                    <p className="text-xs text-slate-500 mt-1">Alternatives</p>
                  </div>
                </div>
              </motion.div>
            )}
...
function EmptyTabState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 text-center">
      ...
      <p className="text-xs text-slate-400 max-w-[250px]">{description}</p>
    </div>
  );
}
