...
const trendIcons = {
  ...
  stable: { icon: IconMinus, color: 'text-slate-400', label: 'Stable' },
...
export function PatternDetailsView({ pattern, compact = false }: PatternDetailsViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-sm font-medium text-slate-900 mb-3">Conditions</h3>
        <div className="space-y-2">
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm text-slate-700">
                  ...
                  <span className="text-slate-500">{operatorLabels[condition.operator]}</span>{' '}
      ...
      {/* Statistical metrics */}
      <div>
        <h3 className="text-sm font-medium text-slate-900 mb-3">Statistical Metrics</h3>
      ...
      <div>
        <h3 className="text-sm font-medium text-slate-900 mb-3">Stroke Impact</h3>
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-600">Strokes per Round</span>
            <span
              className={cn(
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4">
        <div className="flex items-center justify-between mb-2">
          <h4 className="text-sm font-medium text-slate-900">Actionability Score</h4>
