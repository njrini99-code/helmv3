  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h4 className="text-sm font-medium text-slate-600 mb-1">Error Loading Evidence</h4>
        <p className="text-xs text-slate-400 max-w-[250px]">{error}</p>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center mb-4">
          <IconFlag size={24} className="text-slate-300" />
        </div>
        <h4 className="text-sm font-medium text-slate-600 mb-1">No Evidence Available</h4>
  ...
  return (
    ...
    >
      <Link
        ...
        className="block bg-white border border-slate-200 rounded-xl p-4 hover:border-green-200 hover:shadow-sm transition-all group"
      >
...
function StatMini({ label, value }: { label: string; value: string | number }) {
  return (
    <div>
      ...
      <p className="text-sm font-medium text-slate-700 tabular-nums">{value}</p>
    </div>
  );
}
