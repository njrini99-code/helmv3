...
export function ReasoningChainView({ reasoning }: ReasoningChainViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-4">
        ...
        <div className="flex items-center gap-4 mt-3">
          <div className="flex items-center gap-2">
            <span className="text-xs text-slate-500">Raw Confidence:</span>
      ...
      {/* Reasoning chain */}
      <div>
        <h3 className="text-sm font-medium text-slate-900 mb-4">Reasoning Chain</h3>
      ...
      {reasoning.evidence && reasoning.evidence.length > 0 && (
        <div>
          <h3 className="text-sm font-medium text-slate-900 mb-3">Supporting Evidence</h3>
            ...
            >
              <div className="mt-4 ml-13 pl-4 border-l-2 border-green-200 space-y-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">{step.premise}</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">{step.inference}</p>
                </div>
