...
function ActionButton({
  ...
  const variantStyles = {
    ...
    secondary: {
      base: 'bg-white hover:bg-slate-50 text-slate-700 border-slate-200',
      icon: 'bg-slate-100',
    },
    ghost: {
      base: 'bg-transparent hover:bg-red-50 text-slate-500 hover:text-red-600 border-slate-200 hover:border-red-200',
      icon: 'bg-slate-100 group-hover:bg-red-100',
    },
  };
