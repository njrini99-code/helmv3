...
function SummaryChip({
  ...
  return (
    ...
    >
      <div className="text-eyebrow font-medium uppercase tracking-[0.16em] opacity-70">{label}</div>
  ...
  return (
    <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
      {items.map((item, index) => (
        ...
        >
          <div className="text-eyebrow font-medium uppercase tracking-[0.16em] opacity-75">{item.label}</div>
  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} className="h-[19rem] w-full overflow-visible sm:h-[21rem]">
      ...
      <circle
        ...
        opacity={0.45}
      />
      <text x={width / 2} y={height - 8} textAnchor="middle" className="fill-warm-500 text-eyebrow">Tee</text>
      <text x={width / 2} y={padding} textAnchor="middle" className="fill-warm-500 text-eyebrow">Landing area</text>
  ...
  return (
    <svg viewBox={`0 0 ${width} ${height}`} className="h-[19rem] w-full overflow-visible sm:h-[21rem]">
      ...
      <circle
        ...
        opacity={0.9}
      />
      <text x={width / 2} y={padding - 4} textAnchor="middle" className="fill-warm-500 text-eyebrow">Long</text>
      <text x={width / 2} y={height - 10} textAnchor="middle" className="fill-warm-500 text-eyebrow">Short</text>
      <text x={padding - 2} y={height / 2 - 6} textAnchor="start" className="fill-warm-500 text-eyebrow">Left</text>
      <text x={width - padding + 2} y={height / 2 - 6} textAnchor="end" className="fill-warm-500 text-eyebrow">Right</text>
    ...
    <div className="grid grid-cols-3 gap-2 sm:gap-3">
      {SECTOR_GRID.flatMap((row) => row).map((sector) => {
        ...
        return (
          ...
          >
            <div className="text-eyebrow font-medium uppercase tracking-wide text-warm-500">
            ...
            {band && (() => {
              ...
              return secondary !== null ? (
                <div className="mt-2 text-eyebrow text-warm-500">
