      ...
      <div className={cn('', className)}>
        <Card className="py-12">
          <CardContent className="text-center">
            <div className="w-16 h-16 rounded-full bg-warm-100/70 flex items-center justify-center mx-auto mb-4">
      ...
      <div className="flex items-start justify-between">
        ...
        {onRefresh && (
          <button
            onClick={onRefresh}
            disabled={loading}
            className="flex items-center gap-2 px-3 py-2 text-sm text-warm-600 hover:text-warm-900 hover:bg-warm-100/70 active:bg-warm-200 rounded-lg transition-colors"
          >
            <svg
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  {(stats.eagles !== undefined || stats.birdies !== undefined) && (
                    <div className="mt-4">
                      <h4 className="text-sm font-medium text-warm-700 mb-2">Scoring Distribution</h4>
                      <ScoringDistribution
                  ...
                  {comparison.comparisons.map((comp, i) => {
                    ...
                    return (
                      <div key={i} className="flex items-center justify-between py-2 border-b border-warm-100">
                        <span className="text-sm font-medium text-warm-700">{comp.metric}</span>
                        <div className="flex items-center gap-4">
                          <span className="text-sm text-warm-600">{comp.player_value.toFixed(2)}</span>
                          <span
                            className={cn(
                ...
                <div className="grid grid-cols-2 gap-6 mt-6">
                  <div>
                    ...
                    {statisticalStrengths && statisticalStrengths.length > 0 ? (
                      ...
                      <p className="text-sm text-warm-500">No standout strengths</p>
                    )}
                  </div>
                  <div>
                    ...
                    {statisticalWeaknesses && statisticalWeaknesses.length > 0 ? (
                      ...
                      <p className="text-sm text-warm-500">Well-rounded game</p>
                    )}
                  </div>
                </div>
              </CardContent>
                  ...
                  <Card key={i}>
                    <CardContent className="p-4">
                      ...
                      {area.recommended_drills && area.recommended_drills.length > 0 && (
                        <div className="mt-4">
                          <h5 className="text-sm font-medium text-warm-700 mb-2">Recommended Drills:</h5>
