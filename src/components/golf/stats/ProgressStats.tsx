        ...
        {statCards.map((stat, i) => {
          ...
          return (
            <div key={i} className="text-center">
              ...
              <div className="text-h2 md:text-h1 font-medium text-warm-900 tracking-[-0.022em]">
...
const InsightCard = memo(function InsightCard({ stats }: { stats: GolfStats }) {
  ...
  return (
    <div className="bg-cream-50 rounded-2xl border border-warm-200/80 p-6">
      <h3 className="text-eyebrow font-medium text-warm-500 uppercase tracking-[0.12em] opacity-80 mb-4">
        Key Takeaways
      </h3>
