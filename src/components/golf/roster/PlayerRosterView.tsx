          ...
          {players.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-6">
              {players.map((player) => (
                <div
                  key={player.id}
                  className="group surface-matte rounded-3xl transition-all duration-500 [transition-timing-function:cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-[2px] hover:shadow-[0_2px_4px_rgba(58,50,40,0.04),0_24px_44px_rgba(58,50,40,0.07)]"
                >
