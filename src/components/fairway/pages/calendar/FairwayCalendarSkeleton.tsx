 ...
 * switcher), the coach's one-line people row, and a short stack of day
 * groups (a heading, then one grouped card of time-column rows) — all in
...
export function FairwayCalendarSkeleton() {
  return (
    ...
    >
      ...
      {/* ── People row — mirrors FairwayCalendarMemberRail's one line ── */}
      ...
      {/* ── Agenda body — day heading + ONE grouped card of rows per day ── */}
