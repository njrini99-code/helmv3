...
export function FairwayHubSubNav({ tabs, ariaLabel, className }: FairwayHubSubNavProps) {
  ...
  return (
    <nav
      ...
      className={cn(
        'sticky top-[var(--golf-mobile-header-offset)] z-raised w-full fw-glass-chrome border-b',
        className,
      )}
    >
            ...
            <li key={t.id} className="relative shrink-0">
              <Link
                ...
                className={cn(
                  ...
                  isActive ? 'bg-accent-100 text-accent-700' : 'text-text-secondary hover:bg-accent-50 hover:text-accent-700',
                )}
              >
                {Icon ? (
                  <Icon
