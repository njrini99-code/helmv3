...
// Touch screens get the 44pt HIG minimum; a mouse keeps the compact height
...
function pillClassName(selected: boolean, size: 'sm' | 'md', className?: string): string {
  return cn(
    ...
    selected
      ...
      : 'border-border-control bg-surface text-text-secondary hover:border-text-tertiary hover:bg-surface-tint hover:text-text-primary',
    className,
  );
}
