...
const sizeItem: Record<'sm' | 'md' | 'lg', string> = {
  sm: 'min-h-[30px] [@media(pointer:coarse)]:min-h-[44px] px-3 text-body-sm leading-4 gap-1.5',
  ...
  md: 'min-h-[36px] [@media(pointer:coarse)]:min-h-[44px] px-4 text-body-sm leading-4 gap-1.5',
  // 44px touch target (WCAG 2.2 AA 2.5.8) — the item itself is the hit area.
  lg: 'min-h-[44px] px-4 text-body-sm leading-4 gap-1.5',
};
