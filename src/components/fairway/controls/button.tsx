...
const sizeStyles: Record<FwButtonSize, string> = {
  ...
  sm: 'min-h-[36px] [@media(pointer:coarse)]:min-h-[44px] px-3.5 py-1.5 text-body-sm leading-4',
  md: 'min-h-[44px] px-5 py-2.5 text-body leading-6',
  lg: 'min-h-[48px] px-6 py-3 text-body leading-6',
};
