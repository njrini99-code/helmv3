...
export function AxisX({
  ...
  return (
    <g>
      ...
      {ticks.map((t) => (
        <g key={t.value}>
          ...
          <text
            ...
            y={y + 16}
            textAnchor="middle"
            className="fill-warm-500 text-micro tabular-nums"
          >
            {format(t.value)}
          </text>
        </g>
      ...
      {label ? (
        <text x={(x0 + x1) / 2} y={y + 30} textAnchor="middle" className="fill-warm-400 text-micro font-medium uppercase tracking-wide">
          {label}
        </text>
      ) : null}
    </g>
    ...
    <g>
      ...
      {label ? (
        <text
          ...
          className="fill-warm-400 text-micro font-medium uppercase tracking-wide"
        >
          {label}
        </text>
      ) : null}
