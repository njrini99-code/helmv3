...
function LadderMetric({
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <span className="w-9 text-right text-caption tabular-nums text-warm-600">{pct(rate, 0)}</span>
    </div>
  );
}
...
function PairedRow({
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="w-12 text-right text-caption tabular-nums text-warm-600">
