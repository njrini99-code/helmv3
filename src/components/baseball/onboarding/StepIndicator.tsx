...
// ─── Animation Variants ─────────────────────────────────────────────────────
// Single source of truth for the BaseballHelm onboarding wizards (coach + player).
// Mirrors the canonical golf onboarding motion (src/components/golf/onboarding/StepIndicator.tsx)
// so the two sports stay visually in lock-step.
...
export interface StepConfig {
  id: string;
  label: string;
  /** Optional per-step glyph. Rendered in the current step's dot for a premium touch. */
