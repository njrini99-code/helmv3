  ...
  return (
    <Card variant="glass">
      <CardHeader className="flex items-center justify-between">
        <div>
          <h2 className="font-semibold text-warm-900">Team Analytics</h2>
          <p className="text-sm leading-relaxed text-warm-500 mt-1">Performance signals and focus areas</p>
        </div>
        <div className="h-10 w-10 rounded-xl bg-warm-100 flex items-center justify-center">
          <IconChart size={20} className="text-warm-600" />
        </div>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm text-warm-600">
            ...
            <span className="font-medium text-warm-900">{recruitingPercent}%</span>
          </div>
          <div className="h-2 rounded-full bg-warm-200">
            <div
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm text-warm-600">
            ...
            <span className="font-medium text-warm-900">{alertPercent}%</span>
          </div>
          <div className="h-2 rounded-full bg-warm-200">
            <div
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          <div className="rounded-lg border border-warm-200 p-3">
            ...
            <p className="mt-1 text-lg font-semibold text-warm-900">{collegeInterestCount}</p>
          </div>
          <div className="rounded-lg border border-warm-200 p-3">
            <div className="flex items-center gap-2 text-warm-500">
            ...
            <p className="mt-1 text-lg font-semibold text-warm-900">{avgGPA?.toFixed(2) || 'N/A'}</p>
        ...
        <div className="rounded-lg border border-warm-200 p-3">
          <p className="text-sm font-medium text-warm-700">Active Development Plans</p>
          <p className="text-2xl font-semibold text-warm-900 mt-1">{devPlanCount}</p>
