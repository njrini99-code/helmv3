        ...
        {METRICS.map((metric) => (
          <div key={metric.key}>
            ...
            <div className="relative h-8 rounded-lg overflow-hidden">
              ...
              {/* Thumb indicator */}
              <div
                className="absolute top-1/2 -translate-y-1/2 w-4 h-4 bg-cream-50 rounded-full shadow-md border-2 border-primary-500 pointer-events-none transition-all duration-150"
