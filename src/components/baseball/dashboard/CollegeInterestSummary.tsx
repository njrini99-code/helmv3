    ...
    <div className="flex items-center gap-3 py-2.5 border-b border-slate-100 last:border-0">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <p className="text-sm font-medium text-slate-900 truncate">{item.schoolName}</p>
          {item.isWatchlisted && (
    ...
    <div className="relative glass-standard rounded-2xl overflow-hidden">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-semibold text-slate-900 tracking-tight">Who's Looking at Your Players</h2>
      ...
      <div className="p-6">
        {!hasInterest ? (
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <h4 className="text-sm font-medium text-slate-900 mb-1">No college interest yet</h4>
