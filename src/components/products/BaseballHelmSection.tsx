...
export function BaseballHelmSection() {
  ...
  return (
    <section
      id="baseballhelm"
      className="relative py-20 md:py-28 overflow-hidden scroll-mt-20 bg-[#FAFAF8]"
    >
      <motion.div
      ...
      >
        ...
        <motion.div variants={itemVariants} className="text-center max-w-2xl mx-auto mb-16 md:mb-20">
          <div className="flex items-center justify-center gap-3 mb-5">
            ...
            <span className="text-xl font-bold text-slate-900">BaseballHelm</span>
          </div>

          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 leading-[1.1] tracking-tight mb-5">
            Find talent.
            <br />
            <span className="text-blue-600">Build champions.</span>
          </h2>
        ...
        >
          ...
          <div className="order-1 lg:order-2">
            <p className="text-sm font-medium text-purple-600 uppercase tracking-wide mb-3">
              Compare
            </p>
            <h3 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-4 tracking-tight">
        ...
        <motion.div variants={itemVariants} className="relative">
          <div className="bg-slate-900 rounded-2xl p-8 md:p-10 overflow-hidden">
            <div className="relative grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 text-blue-400 text-sm font-medium rounded-md mb-4">
                  <IconVideo size={14} />
                  Video Library
                </div>
