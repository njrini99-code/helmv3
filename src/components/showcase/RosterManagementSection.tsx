    ...
    <section ref={ref} className="py-20 md:py-32 bg-stone-900">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-helm-primary-500/10 border border-helm-primary-500/20 mb-8">
              <Users className="w-4 h-4 text-helm-primary-400" />
              <span className="text-sm font-medium text-helm-primary-400">GolfHelm • Roster</span>
            </div>

            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-[1.1]">
              Your Roster{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-helm-primary-400 to-emerald-400">
                at a Glance
              </span>
            </h2>
            ...
            <div className="space-y-4">
              {[
                ...
                >
                  <div className="w-6 h-6 rounded-full flex items-center justify-center bg-helm-primary-500/20">
                    <Check className="w-3.5 h-3.5 text-helm-primary-400" />
                  </div>
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-8 bg-helm-primary-500/10 rounded-3xl blur-3xl" />
            ...
            <div className="relative bg-white/[0.03] backdrop-blur-xl rounded-2xl border border-white/[0.08] overflow-hidden">
              <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-white/[0.06] flex flex-col sm:flex-row sm:items-center gap-3 sm:justify-between">
                ...
                <div className="flex gap-2">
                  ...
                  <button className="px-3 py-1.5 rounded-lg bg-helm-primary-500/10 text-helm-primary-400 text-xs sm:text-sm hover:bg-helm-primary-500/20 transition-colors">
                    Export
                  </button>
                </div>
              </div>
                  ...
                  <motion.div
                    ...
                    className={`px-4 sm:px-6 py-4 cursor-pointer transition-all
                      ${player.status === 'alert' ? 'bg-amber-500/5 hover:bg-amber-500/10' :
                        player.status === 'surge' ? 'bg-helm-primary-500/5 hover:bg-helm-primary-500/10' :
                        'hover:bg-white/[0.03]'
                      }
                    `}
                  >
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-12 md:items-center">
                      ...
                      <div className="md:col-span-2 md:text-center">
                        <div className="text-white/40 text-micro uppercase tracking-wide md:hidden">Average</div>
                        ...
                        <div className={`text-xs flex items-center gap-1 md:justify-center
                          ${player.trend < 0 ? 'text-helm-primary-400' : player.trend > 0 ? 'text-red-400' : 'text-white/40'}`}>
                      ...
                      {/* Position */}
                      <div className="md:col-span-2 md:text-center">
                        <div className="text-white/40 text-micro uppercase tracking-wide md:hidden">Position</div>
                        <span className="text-white font-medium">#{player.position}</span>
                      </div>

                      {/* Travel Status */}
                      <div className="md:col-span-2 md:text-center">
                        <div className="text-white/40 text-micro uppercase tracking-wide md:hidden">Status</div>
                        <span className={`px-2 py-1 rounded-full text-xs font-medium
                          ${player.travelStatus === 'Locked' ? 'bg-helm-primary-500/20 text-helm-primary-400' :
                      ...
                      <div className="md:col-span-2 flex flex-col gap-2 md:items-center">
                        <div className="text-white/40 text-micro uppercase tracking-wide sm:hidden">Actions</div>
                        ...
                        >
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div className="p-3 rounded-lg bg-white/[0.03]">
                              ...
                              <div className={`font-medium ${player.trend < 0 ? 'text-helm-primary-400' : 'text-red-400'}`}>
