...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading = false, disabled, leftIcon, rightIcon, haptic, children, onClick, ...props }, ref) => {
    ...
    const variants = {
      primary: 'bg-primary-600 text-white shadow-sm hover:bg-primary-700 hover:shadow-md hover:-tranwarm-y-0.5 active:shadow-sm active:tranwarm-y-0',
      ...
      success: 'bg-primary-600 text-white shadow-sm hover:bg-primary-700 hover:shadow-md hover:-tranwarm-y-0.5',
    };
