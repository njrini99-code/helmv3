  ...
  return (
    ...
    <nav className="relative z-modal pointer-events-auto pt-1.5 pb-1 md:pt-2 md:pb-1">
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between md:grid md:grid-cols-[1fr_auto_1fr] md:gap-6">
        ...
        <div className="flex items-center gap-2 justify-self-start md:fixed md:top-4 md:left-6 md:z-toast">
        ...
        <div className="hidden md:fixed md:top-4 md:left-1/2 md:-translate-x-1/2 md:z-toast md:grid grid-cols-3 items-center gap-1
