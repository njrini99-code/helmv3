  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50">
        <div className="absolute inset-0 bg-[#FAFAF8]/90 backdrop-blur-md border-b border-slate-200/50" />
        <div className="relative max-w-5xl mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            <Link
              href="/"
              className="px-4 py-2 text-slate-500 hover:text-slate-900 rounded-lg transition-colors text-sm font-medium"
            >
              Home
            </Link>
            <Link
            ...
            <span className="px-4 py-2 text-slate-900 text-sm font-medium">
              About
            </span>
            <Link
              href="/golf/login"
              className="ml-3 px-5 py-2 bg-slate-900 text-white font-medium rounded-lg
            ...
            >
              <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
                <div className="flex items-center gap-4 mb-5">
                  ...
                  />
                  <div>
                    <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Our Belief</p>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {ambitions.map((item, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="h-full bg-[#FAFAF8] rounded-xl p-6 border border-slate-100
      ...
      {/* Footer */}
      <footer className="py-10 px-5 border-t border-slate-200">
