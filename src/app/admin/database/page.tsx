 ...
 * A-G; D Locks, E Integrity's full workflow contracts, F Jobs/Webhooks are
 * later phases — see docs/observability/SUPABASE_OBSERVABILITY_MEASURED_TRUTH.md
 * §7 for Phase 1's own scope note). Phase 2 Track C added Platform
 * (Metrics API), Advisors, Alert policy, and on-demand log evidence — see
 * docs/observability/SUPABASE_PLATFORM_OBSERVABILITY.md. Every number on
 * this page is read from what the collectors already wrote or a
 * server-only, credential-gated on-demand fetch — nothing here queries
 * production directly from the page render itself except the Metrics API
