      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-warm-500">Start tracking your golf journey</p>
          </div>

          {/* Form */}
          <Suspense fallback={
            <div className="space-y-4 animate-pulse">
              <div className="h-20 bg-warm-200 rounded-[10px]" />
              <div className="grid grid-cols-2 gap-4">
                <div className="h-12 bg-warm-200 rounded-[10px]" />
                <div className="h-12 bg-warm-200 rounded-[10px]" />
              </div>
              <div className="h-12 bg-warm-200 rounded-[10px]" />
              <div className="h-12 bg-warm-200 rounded-[10px]" />
              <div className="h-12 bg-primary-200 rounded-[10px]" />
            </div>
          }>
            <GolfSignUpForm />
          </Suspense>
