  ...
  try {
    const [engagementRes, teamHealthRes, coachEffectivenessRes, onboardingRes] =
      await Promise.all([
        ...
        adminDb.rpc('get_team_health_dashboard' as never) as unknown as { data: Record<string, unknown>[] | null; error: unknown },
        adminDb.rpc('get_coach_effectiveness_metrics' as never) as unknown as { data: Record<string, unknown>[] | null; error: unknown },
        adminDb.rpc('get_onboarding_funnel_analysis' as never) as unknown as { data: Record<string, unknown>[] | null; error: unknown },
      ]);
