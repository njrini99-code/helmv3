    ...
    <button
      ...
      className={
        confirming
          ...
          : 'inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-warm-700 bg-white/70 hover:bg-white border border-warm-200 rounded-lg transition-colors disabled:opacity-60'
      }
    >
