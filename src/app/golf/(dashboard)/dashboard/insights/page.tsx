 ...
 * `/golf/dashboard/insights` at the framework routing layer, before this page
 ...
 * config layer misses (and because `insight-management.ts`,
 * `intelligence-dashboard.ts`, `insight-celebration.ts`, `insights.ts`,
 * `development.ts`, `coaching-philosophy.ts` still call
 * `revalidatePath('/golf/dashboard/insights')`); it should no longer actually
