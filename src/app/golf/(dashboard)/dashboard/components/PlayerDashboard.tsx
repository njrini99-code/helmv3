                        ...
                        <m.div className="mb-7 md:mb-10" variants={itemVariants}>
                            <div className="relative overflow-hidden rounded-3xl surface-apple">
                                ...
                                <div className="relative px-6 py-10 md:px-12 md:py-14 text-center">
                                    ...
                                    <h2 className="text-display md:text-display leading-[1.02] font-light tracking-[-0.035em] text-warm-900 mb-5">
                                        ...
                                        {[
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-caption font-medium text-warm-700 leading-tight tracking-[-0.005em]">
                                                        {item.label}
                                                    </span>
                                                </div>
                                            );
