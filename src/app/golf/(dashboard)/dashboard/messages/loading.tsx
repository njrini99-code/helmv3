  ...
  return (
    <div
      className={fairwayScope(
        'flex h-[calc(100dvh-var(--golf-mobile-header-offset)-56px-env(safe-area-inset-bottom,0px))] flex-col overflow-hidden bg-canvas bg-canvas-gradient md:h-[calc(100dvh-4rem-env(safe-area-inset-top,0px)-env(safe-area-inset-bottom,0px))]',
      )}
    >
