    ...
    <div className="print-shell" data-testid="print-shell">
      ...
      <div className="max-w-[680px] mx-auto p-8 print:p-0">
        ...
        <header className="print-header-block" data-testid="print-header">
          ...
          <p className="text-[11px] text-warm-500 mt-1">Generated {generatedAt}</p>
        </header>
        ...
        <div className="space-y-5 mt-6">
                      ...
                      <ul className="space-y-3" data-testid={`print-insights-${key}`}>
                        {section.insights.slice(0, 5).map((insight) => (
                          ...
                          >
                            ...
                            <p className="text-[11px] text-warm-500 mt-2 tabular-nums">
                            ...
                            {insight.drills && insight.drills.length > 0 && (
                              <p className="text-[11px] text-warm-600 mt-1.5">
                                Drills:{' '}
                                {insight.drills
          ...
          >
            ...
            {fingerprint.trend.rolling.length === 0 ? (
              ...
              >
                <thead>
                  <tr className="text-left text-[11px] uppercase tracking-wide text-warm-500">
        ...
        {/* Footer */}
        <footer
          className="mt-8 pt-4 border-t border-warm-200 text-[10px] text-warm-500 text-center"
