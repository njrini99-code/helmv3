    ...
    <div className="print-shell" data-testid="print-shell">
      ...
      <div className="max-w-[680px] mx-auto p-8 print:p-0">
        ...
        <header className="print-header-block" data-testid="print-header">
          ...
          <p className="text-caption text-text-tertiary mt-1">Generated {generatedAt}</p>
        </header>
        ...
        {/* Footer */}
        <footer
          className="mt-8 pt-4 border-t border-border-subtle text-caption text-text-tertiary text-center"
