        ...
        <div className="space-y-8">
          ...
          <section className="relative glass-standard rounded-2xl p-6 overflow-clip">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-semibold text-warm-900">Basic Information</h2>
          ...
          <section className="relative glass-standard rounded-2xl p-6 overflow-clip">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-semibold text-warm-900">Schedule</h2>
          ...
          <section className="relative glass-standard rounded-2xl p-6 overflow-clip">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-lg font-semibold text-warm-900">Course & Availability</h2>
