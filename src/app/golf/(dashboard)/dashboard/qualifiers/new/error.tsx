    ...
    <div className="min-h-full bg-transparent">
      ...
      <div className="border-b border-warm-200/60 bg-cream-100/60 backdrop-blur-sm">
        <div className="max-w-3xl mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-[20px] font-medium text-warm-900 tracking-[-0.015em]">Create Qualifier</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        <div className="text-center">
          ...
          <h2 className="text-[17px] font-medium text-warm-900 tracking-[-0.012em] mb-2">Something went wrong</h2>
