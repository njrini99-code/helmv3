                        ...
                        <section className="bg-cream-100/75 backdrop-blur-xl border border-white/20 rounded-2xl p-6">
                            <div className="flex items-start justify-between gap-4">
                                ...
                                <label className="relative inline-flex items-center cursor-pointer flex-shrink-0">
                                    ...
                                    />
                                    <div className="w-11 h-6 bg-warm-200 rounded-full peer peer-checked:bg-primary-500 peer-disabled:opacity-50 transition-colors after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-transform peer-checked:after:tranwarm-x-5" />
                                </label>
                            </div>
