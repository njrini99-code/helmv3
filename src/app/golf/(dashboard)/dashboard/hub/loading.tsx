      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-6 md:py-8 space-y-8">
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2 mb-3">
            <div className="h-4 w-4 skeleton-sweep rounded" />
            <div className="h-4 w-28 skeleton-sweep rounded" />
          </div>
          {[...Array(2)].map((_, i) => (
            <div key={i} className="bg-white/70 rounded-2xl border border-white/20 p-5">
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 skeleton-sweep rounded-xl" />
                <div className="flex-1 space-y-2">
                  <div className="h-4 w-40 skeleton-sweep rounded" />
                  <div className="h-3 w-28 skeleton-sweep rounded" />
                  <div className="h-3 w-36 skeleton-sweep rounded" />
                </div>
              </div>
            </div>
          ))}
        ...
        <div className="space-y-3">
          <div className="flex items-center gap-2 mb-3">
            <div className="h-4 w-4 skeleton-sweep rounded" />
            <div className="h-4 w-16 skeleton-sweep rounded" />
          </div>
          {[...Array(3)].map((_, i) => (
            <div key={i} className="bg-white/70 rounded-2xl border border-white/20 p-5">
              <div className="flex items-start gap-4">
                <div className="w-7 h-7 skeleton-sweep rounded-lg" />
                <div className="flex-1 space-y-2">
                  <div className="h-4 w-44 skeleton-sweep rounded" />
                  <div className="h-3 w-32 skeleton-sweep rounded" />
                  <div className="h-3 w-20 skeleton-sweep rounded" />
                </div>
              </div>
            </div>
          ))}
