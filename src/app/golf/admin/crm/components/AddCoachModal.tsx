  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-primary-600 to-teal-500 px-6 py-4">
          <h2 className="text-xl font-bold text-white">Add New Coach</h2>
          <p className="text-primary-100 text-sm">Enter coach details below</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto max-h-[calc(90vh-120px)]">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-warm-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500"
                placeholder="Coach name"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-warm-700 mb-1.5">Title</label>
              <input
                type="text"
                value={form.title}
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-warm-700 mb-1.5">Phone</label>
              <input
                type="tel"
                value={form.phone}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-semibold text-warm-700 mb-1.5">School *</label>
              <input
                type="text"
                required
                value={form.school}
            ...
            <div>
              <label className="block text-sm font-semibold text-warm-700 mb-1.5">Conference *</label>
              <input
                type="text"
                required
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-semibold text-warm-700 mb-1.5">Division</label>
              <select
                value={form.division}
            ...
            <div>
              <label className="block text-sm font-semibold text-warm-700 mb-1.5">Program</label>
              <select
                value={form.program}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-semibold text-warm-700 mb-1.5">Status</label>
              <select
                value={form.status}
            ...
            <div>
              <label className="block text-sm font-semibold text-warm-700 mb-1.5">Priority</label>
              <select
                value={form.priority}
          ...
          {/* Notes */}
          <div>
            <label className="block text-sm font-semibold text-warm-700 mb-1.5">Notes</label>
            <textarea
              value={form.notes}
              onChange={(e) => setForm({ ...form, notes: e.target.value })}
              className="w-full px-4 py-2.5 border border-warm-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none"
              rows={3}
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-warm-100">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="px-5 py-2.5 rounded-xl bg-primary-600 text-white hover:bg-primary-700 disabled:opacity-50 font-bold transition-colors"
            >
