                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      isCurrentMonth && 'hover:bg-white/50'
                    )}
                  >
                    <div className={cn(
                      ...
                      !isCurrentDay && isCurrentMonth && 'text-warm-600 hover:bg-warm-100'
                    )}>
                      {format(date, 'd')}
                    </div>
              ...
              return (
                ...
                >
                  {hours.map((hour) => (
                    <div
                      key={hour}
                      className="h-16 border-b border-warm-100/50 hover:bg-white/50 cursor-pointer transition-colors"
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-2 rounded-lg hover:bg-warm-100 text-warm-500 hover:text-warm-700 transition-colors"
            >
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-sm font-medium text-warm-600 hover:bg-warm-100 hover:text-warm-900 transition-colors"
            >
              Today
            </button>
            <button
          ...
          {googleConnected ? (
            ...
            <button
              ...
              className={cn(
                ...
                'hover:bg-white/80 hover:text-warm-900'
              )}
            >
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
