...
import { IconUsers, IconVideo, IconCalendar, IconNote, IconChevronRight } from '@/components/icons';
            ...
            <div className="col-span-2">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between">
                  ...
                  <Link href="/dashboard/roster" className="text-sm text-green-600 hover:underline flex items-center gap-1">
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Link href="/dashboard/dev-plans" className="block">
                    <Button variant="secondary" className="w-full justify-start">
