...
function PipelineStage({ label, count, color }: { label: string; count: number; color: string }) {
  return (
    <div className="flex items-center justify-between py-3 border-b border-slate-100/50 last:border-0">
...
export default function DashboardPage() {
  ...
  const { stats: coachStats, loading: coachStatsLoading } = useCoachStats();
  const { stats: playerStats, loading: playerStatsLoading } = usePlayerStats();
  ...
  const { searches: savedSearches, loading: searchesLoading } = useSavedSearches();
            ...
            <div className="md:col-span-2 relative group rounded-3xl bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border border-slate-700/50 p-6 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-4 gap-2 mt-6">
                  {(['watchlist', 'high_priority', 'offer_extended', 'committed'] as const).map((stage, i) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 relative bg-white/70 backdrop-blur-xl saturate-150 rounded-2xl border border-white/20 shadow-card overflow-hidden">
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100/50">
                ...
                <Link href="/dashboard/discover" className="text-sm text-slate-500 hover:text-slate-900 flex items-center gap-1 transition-colors group">
            ...
            <div className="space-y-4">
              ...
              <div className="relative bg-white/70 backdrop-blur-xl saturate-150 rounded-2xl border border-white/20 shadow-card p-5 overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link href="/dashboard/calendar" className="text-xs text-slate-500 hover:text-slate-900 transition-colors">
                    View all
                  </Link>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="lg:col-span-2 relative bg-white/70 backdrop-blur-xl saturate-150 rounded-2xl border border-white/20 shadow-card overflow-hidden">
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100/50">
                ...
                <Link href="/dashboard/analytics" className="text-sm text-slate-500 hover:text-slate-900 flex items-center gap-1 transition-colors group">
              ...
              {stateCountsLoading ? (
                ...
                <USMap
                  ...
                  onStateClick={(state) => {
                    ...
                    window.location.href = `/dashboard/discover?state=${state}`;
                  }}
          ...
          {savedSearches.length > 0 && (
            <div className="relative bg-white/70 backdrop-blur-xl saturate-150 rounded-2xl border border-white/20 shadow-card p-5 overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <Link href="/dashboard/discover" className="text-xs text-slate-500 hover:text-slate-900 transition-colors">
                  View all
                </Link>
              </div>
