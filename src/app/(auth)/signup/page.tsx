...
import type { CoachType, PlayerType } from '@/types/database';
...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const onboardingPath = role === 'coach' ? '/coach' : '/player';
      ...
      <div className="min-h-screen bg-[#FAF6F1] flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-semibold text-slate-900">Join Helm Sports Labs</h1>
