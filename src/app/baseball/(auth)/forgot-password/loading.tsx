...
// (this page shares the same BaseballAuthShell + AuthCard chrome) instead of
// the generic dashboard-card PageLoading skeleton — sized to this page's own
// single-input form (email + submit) rather than login's two-input one
// (mobile findings, onboarding-auth group).
