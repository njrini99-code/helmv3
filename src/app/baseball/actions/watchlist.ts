...
export async function updateWatchlistStatus(
  ...
  try {
    ...
    if (error) {
      await logServerError(`[Security] Watchlist update failed: ${{ watchlistId, coachId: coach.id, error: error.message } instanceof Error ? { watchlistId, coachId: coach.id, error: error.message }.message : String({ watchlistId, coachId: coach.id, error: error.message })}`, { action: 'watchlist.updateWatchlistStatus' });
...
export async function updateWatchlistPriority(
  ...
  try {
    ...
    if (error) {
      await logServerError(`[Security] Watchlist priority update failed: ${{ watchlistId, coachId: coach.id, error: error.message } instanceof Error ? { watchlistId, coachId: coach.id, error: error.message }.message : String({ watchlistId, coachId: coach.id, error: error.message })}`, { action: 'watchlist.updateWatchlistPriority' });
...
export async function addWatchlistNote(
  ...
  try {
    ...
    if (error) {
      await logServerError(`[Security] Watchlist note update failed: ${{ watchlistId, coachId: coach.id, error: error.message } instanceof Error ? { watchlistId, coachId: coach.id, error: error.message }.message : String({ watchlistId, coachId: coach.id, error: error.message })}`, { action: 'watchlist.addWatchlistNote' });
