  ...
  return (
    <div className="min-h-dvh bg-cream-100">
      ...
      <div className="mx-auto max-w-[720px] p-6 lg:p-8">
        {/* Hero card */}
        <PaperCard className="mb-6 p-8" grain={false}>
        ...
        <div className="mb-6 grid grid-cols-1 gap-6 md:grid-cols-2">
          {Array.from({ length: 4 }).map((_, i) => (
            <PaperCard key={i} className="p-5 space-y-3" grain={false}>
        ...
        {/* Privacy section */}
        <PaperCard className="mb-6 p-5 space-y-2" grain={false}>
          <Skeleton className="h-5 w-36" />
        ...
        {/* CTA card */}
        <PaperCard className="p-8 text-center" grain={false}>
