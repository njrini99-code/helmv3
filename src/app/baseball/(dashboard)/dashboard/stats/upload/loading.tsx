  ...
  return (
    <div className="min-h-screen bg-[#FFFEFA]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="bg-white/70 backdrop-blur-xl border-2 border-dashed border-slate-200 rounded-2xl p-12">
          <div className="flex flex-col items-center">
            <div className="w-16 h-16 rounded-2xl bg-slate-200 animate-pulse mb-4" />
