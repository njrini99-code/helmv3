...
export function AnalyticsPlayerView({ playerId: _playerId }: Props) {
  // useAnalytics derives the player from the Supabase auth session client-side.
  // The server already verified the session and that this user IS a player before
  // rendering this component — so the hook runs in an authenticated context only.
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card variant="glass">
          <CardContent className="p-6">
            ...
            <p className="text-3xl font-semibold text-warm-900 tabular-nums">
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-warm-50">
                <IconStar size={20} className="text-warm-600" />
              </div>
        ...
        <Card variant="glass">
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-2">
              <div className="p-2 rounded-lg bg-warm-50">
                <IconMessage size={20} className="text-warm-600" />
              </div>
              ...
              {topSchools.map((school, idx) => (
                ...
                >
                  ...
                  <div className="text-right">
                    <p className="text-lg font-semibold tracking-tight text-warm-900 tabular-nums">
