# Peek’n Peak Resort — Upper Course whole-course terrain source

One locked native-1m USGS tile: **USGS one meter x60y466 NY Southwest East 2017**.
Acquisition: 2017-04-18 to 2017-05-09.
Retrieved: 2026-09-16. Immutable hashes and exact projected bounds
are in source-manifest.json and export.json. Do not replace the cached raster.

The EPSG:32617 export is sampled at approximately 1m; the 2m canonical
