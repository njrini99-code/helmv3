...
**Node counts:** 27 features, 72 routes, 45 components, 30 apis, 91 actions, 67 services, 54 tests, 128 tables, 148 rpcs, 27 jobs, 11 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 1014 (merged; an edge with more than one evidence kind is a stronger claim).
...
- **Relations:** 11 doc/structurally-evidenced, 21 import-graph-only (weak)
