...
**Node counts:** 26 features, 69 routes, 44 components, 30 apis, 91 actions, 61 services, 50 tests, 128 tables, 145 rpcs, 27 jobs, 11 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 988 (merged; an edge with more than one evidence kind is a stronger claim).
