...
**Node counts:** 26 features, 70 routes, 42 components, 30 apis, 91 actions, 60 services, 49 tests, 128 tables, 145 rpcs, 27 jobs, 11 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 989 (merged; an edge with more than one evidence kind is a stronger claim).
