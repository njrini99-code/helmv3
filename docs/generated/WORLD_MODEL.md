...
**Node counts:** 25 features, 69 routes, 43 components, 30 apis, 91 actions, 59 services, 49 tests, 128 tables, 145 rpcs, 27 jobs, 11 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 981 (merged; an edge with more than one evidence kind is a stronger claim).
