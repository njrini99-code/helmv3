...
**Node counts:** 28 features, 72 routes, 45 components, 30 apis, 92 actions, 67 services, 55 tests, 132 tables, 158 rpcs, 27 jobs, 17 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 1042 (merged; an edge with more than one evidence kind is a stronger claim).
