...
**Node counts:** 29 features, 66 routes, 45 components, 30 apis, 91 actions, 98 services, 62 tests, 130 tables, 162 rpcs, 28 jobs, 17 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 994 (merged; an edge with more than one evidence kind is a stronger claim).
