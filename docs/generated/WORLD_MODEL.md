...
**Node counts:** 29 features, 66 routes, 46 components, 30 apis, 91 actions, 101 services, 62 tests, 133 tables, 166 rpcs, 28 jobs, 17 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 1002 (merged; an edge with more than one evidence kind is a stronger claim).
...
- **Tables:** `golf_course_edit_history`, `golf_course_tee_edit_history`, `golf_course_tee_holes`, `golf_course_tees`, `golf_demo_sessions`, `golf_penalty_events`, `golf_round_course_bindings`, `golf_shot_anchors`, `golf_team_saved_courses`
- **RPCs:** `reclassify_golf_round`, `record_round_coachhelm_terminal_state`, `resolve_golf_round_course_binding`, `save_partial_round_atomic`, `submit_round_atomic`
- **Test surfaces:** 3
