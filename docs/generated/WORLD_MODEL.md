...
**Node counts:** 25 features, 66 routes, 41 components, 27 apis, 91 actions, 58 services, 49 tests, 128 tables, 136 rpcs, 24 jobs, 11 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 956 (merged; an edge with more than one evidence kind is a stronger claim).
