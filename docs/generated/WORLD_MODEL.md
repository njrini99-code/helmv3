...
**Node counts:** 28 features, 72 routes, 45 components, 30 apis, 92 actions, 72 services, 57 tests, 128 tables, 158 rpcs, 28 jobs, 17 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 1045 (merged; an edge with more than one evidence kind is a stronger claim).
