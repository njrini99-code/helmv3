...
**Node counts:** 26 features, 69 routes, 43 components, 30 apis, 92 actions, 64 services, 52 tests, 128 tables, 155 rpcs, 28 jobs, 11 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 1006 (merged; an edge with more than one evidence kind is a stronger claim).
...
- **RPCs:** `admin_auto_resolve_error_fingerprint`, `admin_mark_error_regressed`, `get_active_sessions`, `get_admin_dashboard_rollup`, `get_crm_coach_stage_history`, `get_crm_email_stats`, `get_crm_events_in_range`, `get_crm_funnel`, `get_crm_stage_ages`, `get_crm_time_to_open`, `get_crm_weekly_kpis`, `get_feature_health`, `get_platform_health_stats`, `helm_debug_db_health_snapshot`, `helm_debug_db_lock_snapshot`, `helm_debug_list_traces`, `helm_debug_prune_observability`, `helm_debug_stat_statements_snapshot`, `is_super_admin`, `recalculate_round_strokes_gained`, `record_db_error_event`, `record_db_health_sample`, `record_db_lock_incident`, `record_db_platform_sample`, `record_db_stat_snapshot`, `refresh_player_stats_cache`, `revoke_user_sessions`
- **Test surfaces:** 3
