...
**Node counts:** 29 features, 66 routes, 45 components, 30 apis, 92 actions, 100 services, 62 tests, 132 tables, 162 rpcs, 28 jobs, 17 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 1000 (merged; an edge with more than one evidence kind is a stronger claim).
...
- **RPCs:** `record_round_coachhelm_terminal_state`
- **Test surfaces:** 3
...
- **Tables:** `golf_course_edit_history`, `golf_course_tee_edit_history`, `golf_course_tee_holes`, `golf_course_tees`, `golf_demo_sessions`, `golf_round_recap_provenance`, `golf_team_saved_courses`
...
- **Tables:** `golf_focus_area_practice_sessions`
