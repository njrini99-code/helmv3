...
**Node counts:** 29 features, 73 routes, 45 components, 30 apis, 91 actions, 78 services, 60 tests, 130 tables, 161 rpcs, 28 jobs, 17 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 979 (merged; an edge with more than one evidence kind is a stronger claim).
