...
**Node counts:** 29 features, 73 routes, 45 components, 30 apis, 91 actions, 78 services, 58 tests, 130 tables, 154 rpcs, 27 jobs, 17 invariants, 86 sentrySignals, 8 journeys.
**Edges:** 973 (merged; an edge with more than one evidence kind is a stronger claim).
...
- **Tables:** `golf_course_edit_history`, `golf_course_tee_edit_history`, `golf_course_tee_holes`, `golf_course_tees`, `golf_demo_sessions`, `golf_team_saved_courses`
...
- **Relations:** 0 doc/structurally-evidenced, 0 import-graph-only (weak)
- **Tables:** `admin_allowlist`, `baseball_staff_audit_events`, `baseball_staff_invitations`, `golf_staff_invite_codes`, `golf_staff_invite_redemptions`
- **RPCs:** none
- **Test surfaces:** 3
- **Sentry/admin_events signals:** none
