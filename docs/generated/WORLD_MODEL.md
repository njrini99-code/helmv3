...
**Node counts:** 29 features, 66 routes, 46 components, 30 apis, 92 actions, 103 services, 65 tests, 134 tables, 165 rpcs, 28 jobs, 17 invariants, 86 sentrySignals, 8 journeys.
...
- **RPCs:** `recalculate_round_strokes_gained`, `recompute_team_sg`, `refresh_player_stats_cache`, `sg_scale_for_player`, `update_player_stats_strokes_gained`
- **Test surfaces:** 3
