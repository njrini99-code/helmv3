...
- **Code:** `src/app/admin/engineering/**`, `src/app/admin/work-log/**`, `src/app/admin/golf/**`, `src/app/admin/traces/**`, `src/app/admin/deploys/**`, `src/app/admin/auth/**` … and 47 more in the registry
