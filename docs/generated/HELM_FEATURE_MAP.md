...
- **Code:** `src/app/admin/**`, `src/app/golf/admin/**`, `src/app/admin/_components/**`, `src/app/golf/admin/crm/components/**`, `src/app/api/admin/**`, `src/app/api/cron/reliability-triage/**` … and 28 more in the registry
