...
- **Code:** `src/app/admin/golf/**`, `src/app/admin/traces/**`, `src/app/admin/deploys/**`, `src/app/admin/auth/**`, `src/app/admin/qualifiers/**`, `src/app/admin/activity/**` … and 44 more in the registry
