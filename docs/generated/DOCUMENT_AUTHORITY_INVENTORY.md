...
| `memory/features/admin-platform.md` | current | yes | - | yes | 11 | 107 | 6 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 7 | 124 | 15 |
