...
| `memory/features/coachhelm-ai.md` | current | yes | - | yes | 9 | 56 | 2 |
...
| `memory/ledgers/changes/coachhelm_ai.md` | current | - | - | - | 2 | 12 | 1 |
...
| `memory/ledgers/tests/coachhelm_ai.md` | current | - | - | - | 1 | 4 | 1 |
