...
| `.claude/rules/shipping.md` | current | - | - | yes | 7 | 12 | 1 |
...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `memory/features/admin-platform.md` | current | yes | - | yes | 4 | 97 | 3 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 3 | 110 | 10 |
...
| `memory/decisions/ADR-2026-09-03-control-plane-owner-decisions.md` | current | - | - | - | 2 | 3 | - |
