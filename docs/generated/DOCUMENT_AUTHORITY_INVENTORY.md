...
| `memory/features/admin-platform.md` | current | yes | - | yes | 10 | 55 | 1 |
...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `docs/ai-system/selfheal/README.md` | current | yes | - | yes | 4 | 8 | - |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 6 | 94 | 8 |
