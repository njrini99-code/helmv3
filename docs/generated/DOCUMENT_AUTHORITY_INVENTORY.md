...
| `.claude/rules/shipping.md` | current | - | - | yes | 6 | 13 | 1 |
...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `memory/features/admin-platform.md` | current | yes | - | yes | 3 | 88 | 2 |
...
| `docs/generated/HELM_FEATURE_MAP.md` | generated | - | - | - | 2 | 136 | 1 |
...
| `docs/ai-system/HANDOFF_BRIDGE_CONTROL_PLANE_2026-09-03.md` | current | - | - | yes | 1 | 40 | 5 |
...
| `docs/ai-system/selfheal/STATE-2026-08-28.md` | current | - | - | yes | 1 | 18 | 1 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 2 | 85 | 8 |
...
| `memory/ledgers/changes/observability_sentry.md` | current | - | - | - | 4 | 37 | - |
