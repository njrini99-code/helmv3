...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `memory/features/admin-platform.md` | current | yes | - | yes | 5 | 134 | 8 |
...
| `docs/ai-system/CONTROL_PLANE_IMPLEMENTATION_PLAN_2026-09-03.md` | current | - | - | yes | 6 | 89 | 19 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 4 | 124 | 12 |
