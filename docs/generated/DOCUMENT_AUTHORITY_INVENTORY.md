...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `memory/features/admin-platform.md` | current | yes | - | yes | 5 | 125 | 8 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 4 | 111 | 12 |
...
| `memory/decisions/ADR-2026-09-03-control-plane-owner-decisions.md` | current | - | - | - | 3 | 3 | 1 |
...
| `supabase/migrations/HELD.md` | current | - | - | - | 5 | 9 | - |
