...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `memory/features/admin-platform.md` | current | yes | - | yes | 2 | 91 | 5 |
...
| `memory/ledgers/tests/admin_platform.md` | current | - | - | yes | 2 | 52 | 4 |
