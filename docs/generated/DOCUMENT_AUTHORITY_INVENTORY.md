...
| `docs/observability/SENTRY_PHASE_A_FINDINGS.md` | current | - | - | - | 0 | 22 | 5 |
...
| `docs/observability/SENTRY_SDK_API_VERIFICATION.md` | current | - | - | yes | 0 | 4 | - |
