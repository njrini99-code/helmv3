...
| `memory/features/coachhelm-ai.md` | current | yes | - | yes | 8 | 54 | - |
...
| `memory/ledgers/changes/coachhelm_ai.md` | current | - | - | - | 2 | 10 | - |
...
| `memory/ledgers/tests/coachhelm_ai.md` | current | - | - | - | 1 | 3 | - |
