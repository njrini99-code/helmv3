...
| `memory/features/admin-platform.md` | current | yes | - | yes | 11 | 93 | 2 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 7 | 122 | 14 |
