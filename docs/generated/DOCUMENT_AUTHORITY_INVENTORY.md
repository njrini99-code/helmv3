...
| `.claude/rules/database-review.md` | current | - | - | yes | 4 | 5 | - |
| `.claude/rules/database.md` | current | - | - | - | 5 | 5 | - |
| `.claude/rules/design-system.md` | current | - | - | yes | 11 | 6 | - |
...
| `.claude/rules/golfhelm-engineering-os.md` | current | - | - | - | 1 | 3 | - |
| `.claude/rules/integrations.md` | current | - | - | - | 4 | 10 | - |
| `.claude/rules/quality-gates.md` | current | - | - | - | 8 | 7 | - |
| `.claude/rules/shipping.md` | current | - | - | - | 22 | 3 | - |
| `AGENTS.md` | current | yes | - | yes | 0 | 14 | - |
| `CLAUDE.md` | current | yes | - | yes | 0 | 2 | - |
| `CONTRIBUTING.md` | current | - | - | yes | 0 | 3 | - |
| `README.md` | current | - | - | - | 0 | 4 | - |
...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `.claude/agents/code-reviewer.md` | current | - | - | - | 0 | 1 | - |
| `.claude/agents/db-migration-reviewer.md` | current | - | - | yes | 0 | 2 | - |
| `.claude/agents/debugger.md` | current | - | - | - | 0 | 0 | - |
| `.claude/agents/helm-reader.md` | current | - | - | - | 0 | 2 | - |
| `.claude/agents/helm-worker.md` | current | - | - | - | 0 | 0 | - |
| `.claude/agents/security-reviewer.md` | current | - | - | yes | 0 | 1 | - |
| `.claude/agents/ui-polish-reviewer.md` | current | - | - | - | 0 | 3 | - |
...
| `.claude/skills/pencil-golfhelm/SKILL.md` | current | - | - | yes | 0 | 4 | - |
...
| `memory/context/agent-operations.md` | current | yes | - | - | 2 | 3 | - |
...
| `memory/system/golfhelm-engineering-os.md` | current | - | - | yes | 16 | 16 | - |
...
| `docs/audits/ROUND_SUBMIT_TIMEOUT_INVERSION_2026-08-20.md` | current | - | - | - | 0 | 5 | 1 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 7 | 161 | 9 |
...
| `memory/ledgers/changes/calendar_events.md` | current | - | - | - | 1 | 3 | 1 |
...
| `memory/incidents/feature_awareness_system/INC-2026-08-16-parallel-agents-shared-tree.md` | current | yes | - | yes | 1 | 2 | 1 |
| `memory/incidents/feature_awareness_system/INC-2026-08-18-worktrees-inside-repo-duplicate-tree.md` | current | yes | - | - | 1 | 2 | 1 |
...
| `docs/ai-system/GOLFHELM_SELF_HEALING_ENGINEERING_SYSTEM.md` | current | - | - | yes | 5 | 19 | 11 |
| `docs/ai-system/helmv3-ai-codebase-intelligence.md` | current | yes | - | yes | 3 | 14 | - |
...
| `docs/operations/APPLY_PATH.md` | current | - | - | - | 2 | 5 | - |
