...
| `memory/features/coachhelm-ai.md` | current | yes | - | yes | 6 | 49 | - |
...
| `memory/features/player-coachhelm-development.md` | current | yes | - | - | 1 | 29 | - |
...
| `docs/architecture/coachhelm-evidence-contract.md` | current | yes | - | yes | 4 | 27 | - |
