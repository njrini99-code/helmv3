...
| `memory/features/shot-tracking.md` | current | yes | - | yes | 5 | 50 | 2 |
...
| `memory/ledgers/changes/shot_tracking.md` | current | - | - | - | 2 | 27 | 10 |
...
| `memory/ledgers/tests/shot_tracking.md` | current | - | - | - | 2 | 44 | 15 |
