...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `memory/features/admin-platform.md` | current | yes | - | yes | 2 | 72 | 5 |
...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `docs/ai-system/selfheal/README.md` | current | - | - | yes | 3 | 7 | 1 |
| `docs/ai-system/selfheal/repair-contract.md` | current | - | - | yes | 1 | 8 | 1 |
| `docs/ai-system/selfheal/triage-contract.md` | current | - | - | yes | 0 | 8 | 2 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | - | 1 | 53 | 10 |
