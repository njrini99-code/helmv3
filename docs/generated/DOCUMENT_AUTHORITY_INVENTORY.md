...
| `memory/features/coachhelm-ai.md` | current | yes | - | yes | 7 | 53 | - |
...
| `memory/ledgers/changes/coachhelm_ai.md` | current | - | - | - | 2 | 6 | - |
...
| `memory/ledgers/tests/coachhelm_ai.md` | current | - | - | - | 1 | 2 | - |
