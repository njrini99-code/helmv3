...
| Path | Lifecycle | Routed | AUTOGEN | Authority? | In | Out | Dead |
| --- | --- | --- | --- | --- | --- | --- | --- |
| `memory/features/admin-platform.md` | current | yes | - | yes | 5 | 120 | 5 |
...
| `memory/ledgers/changes/admin_platform.md` | current | - | - | yes | 4 | 110 | 12 |
