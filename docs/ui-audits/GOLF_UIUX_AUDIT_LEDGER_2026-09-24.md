...
| DASH-07 | [P2] Stats: three filter controls before any data; combobox double focus ring, blank first row, "(real)" suffix, a ... | partial: One scope control and clean names done; QA qualifier preset still shows until the OD-03 filter | StatsSpineStage.tsx:505 | verified in code |
...
| DASH-12 | [P1] Stats server fetch + putting benchmark module + Stats field sheet (spec §3.2/§5, plan #7) | residual: Field sheet and putting benchmark module not built | golf/stats field-sheet; lib/golf/benchmarks/putting.ts | verified in code |
...
| DS-12 | [P1] Phase 2 primitives: Masthead, VerdictLine, Row, MetricValue, TemplateSkeleton, KeyboardDoneBar; Stage variant ... | partial: Only MetricValue built; Masthead, VerdictLine, Row, TemplateSkeleton, KeyboardDoneBar not built | MetricValue.tsx | verified in code |
| DS-13 | [P1] Instruments RoundStrip, TeamField, SignedBars, TargetTrack, SplitStrip | partial: RoundStrip exists in player detail; TeamField, SignedBars, TargetTrack, SplitStrip not built | player-detail/RoundStrip.tsx | per transcript |
...
| DS-15 | [P2] 108 ad-hoc `active:scale` → one Pressable (fwPress 0.97) | partial: Shared fwPress/fwPressSurface exported; golf page sites migrated, 52 to 40 (c7dc95a08). Remaining: primitive definitions, Baseball-shared calendar, admin CRM | c7dc95a08 | this session |
