...
| DASH-12 | [P1] Stats server fetch + putting benchmark module + Stats field sheet (spec §3.2/§5, plan #7) | partial: putting.ts (golf_pga_standards, cited) and the Putting benchmark Sheet built; a full field-sheet page rebuild waits on a scope call (spec-dashboard-shell lost) | caf753eef, 03a21a4c1; lib/golf/benchmarks/putting.ts; spine-stage/PuttingBenchmarkSheet.tsx | verified in code |
