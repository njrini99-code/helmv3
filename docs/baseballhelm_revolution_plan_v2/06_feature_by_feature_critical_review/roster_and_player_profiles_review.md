# Roster and Player Profiles Review

## 1. Original plan summary

V1 recognized `Roster and Player Profiles` as an important product area, but it was not always specific enough about role behavior, data ownership, edge cases, UI states, and implementation cutline.
...
Competitors researched: Teamworks roster, BaseballCloud profiles, spreadsheets.
