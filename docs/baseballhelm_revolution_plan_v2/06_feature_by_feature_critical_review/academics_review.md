...
V1 recognized `Academics` as an important product area, but it was not always specific enough about role behavior, data ownership, edge cases, UI states, and implementation cutline.
...
Competitors researched: Teamworks Academics, advisor workflows.
...
Phase recommendation: **Import conflict layer only**.
...
**Import conflict layer only.** Build only to the depth needed to support the V2 operating graph.
