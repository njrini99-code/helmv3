# Hitting Development Review

## 1. Original plan summary

V1 recognized `Hitting Development` as an important product area, but it was not always specific enough about role behavior, data ownership, edge cases, UI states, and implementation cutline.
...
Competitors researched: Rapsodo, TrackMan, Blast, BaseballCloud, OnForm.
...
Estimated complexity: 5/10. Complexity rises when imports, permissions, or AI are involved.
