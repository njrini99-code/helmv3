...
## Proposed route consolidation

| V1 / current surface | V2 destination |
|---|---|
| Dashboard / Command Center | `/baseball/dashboard/command-center` or default coach landing |
| Roster | Roster + player identity + profile/timeline |
| Player Profiles | Child route under roster/player |
| Calendar, Travel, Tasks, Announcements | Team Ops / Calendar group |
| Lifting, Wellness, Availability | Performance group |
| Hitting/Pitching Development | Player Profile tabs and Phase 2 development surfaces |
| CoachHelm AI | Embedded cards; no separate primary nav |
| Recruiting | Hidden/deferred |
