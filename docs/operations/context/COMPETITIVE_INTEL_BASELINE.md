...
> Purpose: A single, partner-readable competitor map for Helm Sports Labs (GolfHelm + BaseballHelm), grouped by market. It seeds the Huly "Competitive Intel" space and gives n8n/the external review bot a stable reference for "who do we compete with, and where is our edge?"
>
