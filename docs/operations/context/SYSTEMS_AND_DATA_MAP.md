...
>
> **Ground-truth sources this doc summarizes:** [.devin/wiki.json](../../../.devin/wiki.json), [docs/CODEBASE_MAP.md](../../CODEBASE_MAP.md), [docs/architecture/ROUTE_INVENTORY.md](../../architecture/ROUTE_INVENTORY.md), [memory/context/golfhelm-database.md](../../../memory/context/golfhelm-database.md), [memory/context/baseballhelm-database.md](../../../memory/context/baseballhelm-database.md), [memory/glossary.md](../../../memory/glossary.md).
>
...
| **Route Inventory** | [docs/architecture/ROUTE_INVENTORY.md](../../architecture/ROUTE_INVENTORY.md) | Every page/layout/route group, protection status, loading/error coverage, orphaned pages, broken links, middleware public/role-restricted route lists. **Best route-level map — but its "API Routes = 3" is stale;** the repo now has ~45 `/api/**` `route.ts` handlers incl. `/api/cron/**` (see §5). | Generated **2026-01-01** |
