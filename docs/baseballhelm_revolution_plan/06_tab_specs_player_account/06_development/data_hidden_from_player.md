# Development — Data Hidden From Player

## Purpose

The player Development tab gives the athlete player growth and coach feedback without exposing coach-only complexity.
