# Game Recap Assistant

## Purpose

Provide a practical AI assistant module for game recap assistant that helps college baseball staff convert entered/imported data into decisions.
