# Player-Facing AI Summary

## Purpose

Provide a practical AI assistant module for player-facing ai summary that helps college baseball staff convert entered/imported data into decisions.
