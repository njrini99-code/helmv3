# Pitching Staff Analyst

## Purpose

Provide a practical AI assistant module for pitching staff analyst that helps college baseball staff convert entered/imported data into decisions.
