# Hitting Group Analyst

## Purpose

Provide a practical AI assistant module for hitting group analyst that helps college baseball staff convert entered/imported data into decisions.
