# Recruiting Board Assistant

## Purpose

Provide a practical AI assistant module for recruiting board assistant that helps college baseball staff convert entered/imported data into decisions.
