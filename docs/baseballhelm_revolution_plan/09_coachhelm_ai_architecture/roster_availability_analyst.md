# Roster And Availability Analyst

## Purpose

Provide a practical AI assistant module for roster and availability analyst that helps college baseball staff convert entered/imported data into decisions.
