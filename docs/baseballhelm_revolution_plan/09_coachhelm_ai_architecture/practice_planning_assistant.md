# Practice Planning Assistant

## Purpose

Provide a practical AI assistant module for practice planning assistant that helps college baseball staff convert entered/imported data into decisions.
