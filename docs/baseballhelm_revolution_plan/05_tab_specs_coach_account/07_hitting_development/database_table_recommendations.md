# Hitting Development — Database Table Recommendations

## Purpose

Hitting Development exists to support hitter development timelines and imported swing data for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, hitting_sessions, swing_metrics, player_development_notes`.
