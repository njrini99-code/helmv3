# Pitching Development — Database Table Recommendations

## Purpose

Pitching Development exists to support pitcher development, bullpens, workload, pitch metrics for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, pitching_sessions, bullpen_sessions, pitch_metrics, arm_care_logs, throwing_programs`.
