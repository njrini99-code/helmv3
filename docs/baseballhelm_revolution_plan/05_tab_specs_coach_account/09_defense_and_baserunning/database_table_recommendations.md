# Defense & Baserunning — Database Table Recommendations

## Purpose

Defense & Baserunning exists to support defensive reliability and baserunning grades for a college baseball program.
