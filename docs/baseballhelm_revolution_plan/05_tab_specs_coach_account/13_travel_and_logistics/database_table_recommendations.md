# Travel & Logistics — Database Table Recommendations

## Purpose

Travel & Logistics exists to support trip itinerary and player logistics for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, travel_trips, travel_rosters, travel_itinerary_items`.
