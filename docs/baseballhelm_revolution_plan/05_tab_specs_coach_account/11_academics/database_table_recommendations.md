# Academics — Database Table Recommendations

## Purpose

Academics exists to support lightweight conflict/risk tracking for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, class_schedules, academic_notes, study_hall_logs`.
