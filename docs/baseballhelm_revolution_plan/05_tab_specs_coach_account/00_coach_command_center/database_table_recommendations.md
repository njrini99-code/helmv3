# Coach Command Center — Database Table Recommendations

## Purpose

Coach Command Center exists to support daily program command and risk triage for a college baseball program.
