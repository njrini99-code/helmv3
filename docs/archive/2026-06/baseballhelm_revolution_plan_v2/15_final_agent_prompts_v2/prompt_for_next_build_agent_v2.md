# Prompt For Next Build Agent V2

For Claude Ultracode, prefer `CLAUDE_ULTRACODE_MASTER_PROMPT.md`. This shorter prompt is still useful for a general build agent, but the Claude-specific version has stronger session sequencing, repo inspection targets, and stop conditions.
