# Pitching Development Review

## 1. Original plan summary

V1 recognized `Pitching Development` as an important product area, but it was not always specific enough about role behavior, data ownership, edge cases, UI states, and implementation cutline.
...
Competitors researched: Rapsodo, TrackMan, Yakkertech, BaseballCloud, ArmCare, OnForm.
...
Phase recommendation: **Build after first pilot**.
...
Estimated complexity: 4/10. Complexity rises when imports, permissions, or AI are involved.
...
**Build after first pilot.** Build only to the depth needed to support the V2 operating graph.
