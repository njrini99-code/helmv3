...
V1 recognized `Reports` as an important product area, but it was not always specific enough about role behavior, data ownership, edge cases, UI states, and implementation cutline.
...
Competitors researched: Teamworks reports, stat PDFs, staff packets.
...
Phase recommendation: **Build for demo**.
...
**Build for demo.** Build only to the depth needed to support the V2 operating graph.
