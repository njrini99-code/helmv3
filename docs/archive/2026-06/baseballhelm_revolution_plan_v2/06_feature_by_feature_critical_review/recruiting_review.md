...
V1 recognized `Recruiting` as an important product area, but it was not always specific enough about role behavior, data ownership, edge cases, UI states, and implementation cutline.
...
Competitors researched: FieldLevel, NCSA, SportsRecruits, Perfect Game, Prep Baseball, ARMS.
...
Estimated complexity: 9/10. Complexity rises when imports, permissions, or AI are involved.
...
**Defer.** Build only to the depth needed to support the V2 operating graph.
