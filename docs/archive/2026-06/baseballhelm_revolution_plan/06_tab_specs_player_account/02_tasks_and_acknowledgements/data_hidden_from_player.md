# Tasks & Acknowledgements — Data Hidden From Player

## Purpose

The player Tasks & Acknowledgements tab gives the athlete required player actions without exposing coach-only complexity.
