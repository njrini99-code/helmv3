# Import Center — Database Table Recommendations

## Purpose

Import Center exists to support generic import mapping, validation, history, rollback for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, imports, import_rows, import_errors, import_mappings`.
