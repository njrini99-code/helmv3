# Lifting & Performance — Database Table Recommendations

## Purpose

Lifting & Performance exists to support baseball-specific lift assignment and compliance for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, lift_programs, lift_workouts, lift_assignments, lift_results, wellness_checkins`.
