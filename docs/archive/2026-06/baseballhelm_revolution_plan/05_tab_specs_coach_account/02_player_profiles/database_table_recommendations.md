# Player Profiles — Database Table Recommendations

## Purpose

Player Profiles exists to support holistic player timeline and profile for a college baseball program.
