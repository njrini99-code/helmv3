# Recruiting Board — Database Table Recommendations

## Purpose

Recruiting Board exists to support optional prospect and roster-building CRM for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, recruiting_prospects, recruiting_evaluations, recruiting_tasks`.
