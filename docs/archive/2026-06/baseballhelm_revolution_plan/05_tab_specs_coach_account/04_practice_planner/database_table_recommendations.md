# Practice Planner — Database Table Recommendations

## Purpose

Practice Planner exists to support baseball-specific practice planning and execution for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, practices, practice_blocks, practice_attendance, practice_grades, drill_library`.
