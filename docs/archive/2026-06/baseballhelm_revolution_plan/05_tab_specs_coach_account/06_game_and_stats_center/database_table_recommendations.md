# Game & Stats Center — Database Table Recommendations

## Purpose

Game & Stats Center exists to support official stats plus coach grades and imports for a college baseball program.
...
Suggested tables: `players, team_memberships, calendar_events, tasks, acknowledgements, ai_insights, audit_logs, games, game_stats_hitting, game_stats_pitching, game_stats_fielding, game_stats_baserunning, season_stats`.
