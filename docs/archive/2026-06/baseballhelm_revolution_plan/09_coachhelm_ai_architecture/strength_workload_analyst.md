# Strength And Workload Analyst

## Purpose

Provide a practical AI assistant module for strength and workload analyst that helps college baseball staff convert entered/imported data into decisions.
