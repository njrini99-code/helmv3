# Academic Conflict Assistant

## Purpose

Provide a practical AI assistant module for academic conflict assistant that helps college baseball staff convert entered/imported data into decisions.
