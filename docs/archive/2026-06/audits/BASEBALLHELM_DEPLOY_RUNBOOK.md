...
- [ ] **Migration apply plan exists.** Confirm `docs/archive/2026-06/audits/BASEBALLHELM_MIGRATION_APPLY_PLAN.md` is present. It is the authoritative ordered list of which `*_baseball_*` migrations to apply and in what order. The runbook defers to it for ordering.
