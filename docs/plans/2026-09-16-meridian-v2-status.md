...
- Task 20 carries the per-stage mount-compile split and a Web Worker
  ...
  digest-identical on holes 3, 7, 8 and 18 and every lab frame at 0.00 %
  pixel mismatch.
