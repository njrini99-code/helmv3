...
- Whole-course One-Tap V2 audit (2026-09-17, `capture-one-tap.cjs --world=v2`,
  ...
  after it: 4.0 s). The last hole renders NEXT HOLE disabled, which the
