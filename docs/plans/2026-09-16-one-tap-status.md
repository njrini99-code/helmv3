...
| 7–18 | open | lie presentation, HUD, green readout, hole integrity, penalties, shot reveal, sync + migration (branch only), ledger adapter + placement, offline, competition, trace matrix, calibration doc. |
