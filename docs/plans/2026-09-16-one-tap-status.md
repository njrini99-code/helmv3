...
| 12–13, 17–18 | open | shot reveal (Opus agent, branch agent/one-tap-task12), sync + migration branch-only (Opus agent, agent/one-tap-task13), trace matrix, calibration doc. |
