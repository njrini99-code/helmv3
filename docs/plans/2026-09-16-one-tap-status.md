...
| 12–13, 15–18 | open | shot reveal (Opus agent, branch agent/one-tap-task12), sync + migration branch-only (Opus agent, agent/one-tap-task13), offline, competition, trace matrix, calibration doc. |
