...
| 26 | Performance acceptance | done (v1, Mac Chromium) | Player view hole 7 phone Terrain: 159 draws against the 160 budget at the standard tier (was ~350, then 208 before the batch change), frame P95 13.9 ms CPU; lab phone Terrain draws with the same tiers: hole 9 65, hole 11 81, hole 17 78 at standard; hole 11 136, hole 17 109 at high (budget 180, all within); canary telemetry per hole with budget status. Real-device numbers remain the §103 human step |
