...
| --- | --- | --- | --- | --- |
| Supabase | `mcp__supabase__*` | project-scoped: qmnssrrolpinvwjjnufo, read_only=true | .mcp.json (this repo) | **STALE** — observed 2026-09-01 under config 7a677da5aeb057cd; config is now 34995f9b79d657e5 |
| Sentry | `mcp__claude_ai_Sentry__*` | org helm-xs | account connector | **STALE** — observed 2026-08-29 under config 6965b945cbb523f5; config is now f6518f7dd18f5f0a |
| Vercel | `mcp__claude_ai_Vercel__*` | account | account connector | **STALE** — observed 2026-09-01 under config 5b174c1ef5d936bb; config is now 19c7c322e00d5794 |
...
| --- | --- | --- |
| Supabase | `34995f9b79d657e5` | yes — derived from the allow/deny/ask rules and `.mcp.json` entries naming this service |
| Sentry | `f6518f7dd18f5f0a` | yes — derived from the allow/deny/ask rules and `.mcp.json` entries naming this service |
| Vercel | `19c7c322e00d5794` | yes — derived from the allow/deny/ask rules and `.mcp.json` entries naming this service |
