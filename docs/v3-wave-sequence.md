...
| W29-pt2 | Qualifying service + actions + selection workspace UI | ⬜ | — | New v3 route at `dashboard/coachhelm/qualifying/[id]` + "Manage selections →" link from existing `qualifiers/[id]/page.tsx`. See Part XV.0. |
