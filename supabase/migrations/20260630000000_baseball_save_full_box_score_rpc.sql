-- =============================================================================
-- BaseballHelm — atomic full box-score save RPC
-- Migration: 20260630000000_baseball_save_full_box_score_rpc.sql
-- =============================================================================
...
DECLARE
  ...
  v_coach_id uuid;
  v_team_id uuid;
  v_season_year integer := EXTRACT(YEAR FROM now())::integer;
  v_player_id uuid;
  v_bat jsonb;
  v_pit jsonb;
BEGIN
  ...
  SELECT bg.team_id INTO v_team_id
