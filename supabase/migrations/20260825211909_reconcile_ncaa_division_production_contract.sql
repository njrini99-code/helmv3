...
ALTER TYPE public.ncaa_division ADD VALUE IF NOT EXISTS 'JUCO_D2' AFTER 'JUCO_D1';
ALTER TYPE public.ncaa_division ADD VALUE IF NOT EXISTS 'JUCO_D3' AFTER 'JUCO_D2';
