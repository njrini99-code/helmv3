...
CREATE TABLE IF NOT EXISTS public.golf_message_reactions (
    ...
    message_id uuid NOT NULL REFERENCES public.golf_messages (
        id
    ) ON DELETE CASCADE,
    ...
    CONSTRAINT golf_message_reactions_unique UNIQUE (
    ...
    CONSTRAINT golf_message_reactions_emoji_len CHECK (
...
DROP POLICY IF EXISTS golf_message_reactions_select
ON public.golf_message_reactions;
...
USING (
    EXISTS (
        ...
        WHERE
            m.id = golf_message_reactions.message_id
...
DROP POLICY IF EXISTS golf_message_reactions_insert
ON public.golf_message_reactions;
...
DROP POLICY IF EXISTS golf_message_reactions_delete
ON public.golf_message_reactions;
