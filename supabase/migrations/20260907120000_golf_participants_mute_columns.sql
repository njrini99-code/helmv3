...
--
-- REVERSAL: `ALTER TABLE public.golf_conversation_participants DROP COLUMN
-- notification_level, DROP COLUMN muted_until;` — destructive, and only ever
-- correct in an environment where this migration actually created them. Never
