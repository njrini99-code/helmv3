...
-- and set coachhelm_analyzed_at to the insight's created_at (or NOW()
-- as a fallback). Rounds without matching insights remain
...
SET coachhelm_analyzed_at = COALESCE(
  (
