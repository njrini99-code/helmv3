...
-- VERIFY: 'public.helm_jobs_pg_cron_consume_tick(text)'::regprocedure;
-- VERIFY: select 1 where has_function_privilege('anon',
-- VERIFY: 'public.helm_jobs_pg_cron_consume_tick(text)', 'execute') = false;
-- VERIFY: select 1 where has_function_privilege('authenticated',
-- VERIFY: 'public.helm_jobs_pg_cron_consume_tick(text)', 'execute') = false;
-- VERIFY: select 1 where has_function_privilege('service_role',
-- VERIFY: 'public.helm_jobs_pg_cron_consume_tick(text)', 'execute');
