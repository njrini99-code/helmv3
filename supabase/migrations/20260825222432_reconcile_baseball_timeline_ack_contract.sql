...
drop policy if exists baseball_timeline_acks_select
...
'Per-user acknowledgement of a player timeline event. The legacy acked_* '
'and canonical acknowledged_* columns are synchronized by the server '
'action during the compatibility window.';
