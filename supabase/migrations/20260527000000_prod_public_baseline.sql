...
-- Extensions required by the public schema baseline (added during Phase 5 sanitization)
-- Types and operator classes the dump qualifies with "public." -> install into public
CREATE EXTENSION IF NOT EXISTS "pgcrypto"  WITH SCHEMA "public";
CREATE EXTENSION IF NOT EXISTS "uuid-ossp" WITH SCHEMA "public";
CREATE EXTENSION IF NOT EXISTS "citext"    WITH SCHEMA "public";
CREATE EXTENSION IF NOT EXISTS "vector"    WITH SCHEMA "public";
CREATE EXTENSION IF NOT EXISTS "pg_trgm"   WITH SCHEMA "public";
-- hypopg lives in "extensions" on prod; public has a wrapper function calling extensions.hypopg_reset()
...
-- owner-stripped: ALTER SCHEMA "public" OWNER TO "pg_database_owner";
...
-- owner-stripped: ALTER TYPE "public"."admin_event_severity" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."baseball_coach_type" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."baseball_pipeline_stage" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."baseball_player_type" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."coach_status" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."contact_type" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."crm_event_type" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."email_status" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."golf_expense_category" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."golf_expense_paid_by" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."ncaa_division" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."notification_type" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."organization_type" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."program_type" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."reminder_type" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."team_member_status" OWNER TO "postgres";
...
-- owner-stripped: ALTER TYPE "public"."user_role" OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."__admin_rollup_b_gate"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."calculate_round_strokes_gained"("p_round_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."calculate_strokes_gained_on_round_complete"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
-- owner-stripped: ALTER FUNCTION "public"."calculate_strokes_gained_on_round_complete"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."coach_id_for_team"("p_team_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."current_coach_id"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."current_player_id"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."extract_email_click_from_event"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_analytics_rollup"("p_ago7d" timestamp with time zone, "p_ago30d" timestamp with time zone, "p_ago12w" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_baseball_rollup"("p_ago30d" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_coachhelm_rollup"("p_ago7d" timestamp with time zone, "p_ago30d" timestamp with time zone, "p_ago12w" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_dashboard_rollup"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_errors_rollup"("p_ago7d" timestamp with time zone, "p_ago24h" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_event_summary"("p_days_back" integer) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_feature_adoption_rollup"("p_ago30d" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_rounds_rollup"("p_today" timestamp with time zone, "p_ago24h" timestamp with time zone, "p_ago7d" timestamp with time zone, "p_ago14d" timestamp with time zone, "p_ago30d" timestamp with time zone, "p_ago60d" timestamp with time zone, "p_ago12w" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_teams_scoring_rollup"("p_ago7d" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_admin_users_rollup"("p_ago7d" timestamp with time zone, "p_ago14d" timestamp with time zone, "p_ago30d" timestamp with time zone, "p_ago12w" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_api_performance_summary"("days_back" integer) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_audit_log_recent"("limit_count" integer) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_baseball_conversations_with_details"("p_user_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_coach_effectiveness_metrics"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_coach_today_schedule"("p_team_id" "uuid", "p_today_start" timestamp with time zone, "p_today_end" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_crm_click_destinations"("p_window" "text", "p_limit" integer) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_crm_coach_email_events"("p_coach_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_crm_email_stats"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_crm_email_stats_detailed"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_crm_events_in_range"("p_start" timestamp with time zone, "p_end" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_crm_template_performance"("p_window" "text") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_crm_time_to_open"("p_window" "text") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_current_golf_player_id"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_current_player_team_ids"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_db_telemetry"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_enhanced_system_health"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_error_summary"("days_back" integer) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_golf_conversations_with_details"("p_user_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_golf_message_attachments"("p_message_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_my_baseball_conversation_ids"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_my_coach_id"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_my_player_id"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_onboarding_funnel_analysis"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_pending_task_reminders"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_platform_health_stats"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_player_hub_announcements"("p_team_id" "uuid", "p_player_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_player_hub_events"("p_team_id" "uuid", "p_player_id" "uuid", "p_since" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_player_stats_summary"("p_player_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_qualifier_leaderboard"("qualifier_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_resend_activity_stats"("p_window" "text") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_resend_domain_breakdown"("p_window" "text") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_shot_data_quality"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_team_health_dashboard"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_user_engagement_summary"("time_range_days" integer) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_user_golf_organization_id"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_user_golf_team_ids"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_user_last_active"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."get_users_with_auth"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."golf_event_documents_assert_same_team"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."golf_holes_recompute_round_totals_fn"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."golf_holes_set_gir_fn"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."handle_new_user"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."heartbeat"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."hypopg_reset"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_admin"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_baseball_primary_coach"("p_team_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_baseball_team_coach"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_baseball_team_coach_v2"("p_team_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_baseball_team_member"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_baseball_team_member_v2"("p_team_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_baseball_team_player"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_golf_team_coach"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_golf_team_player"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_golf_team_primary_coach"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_in_team"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_team_coach"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_team_player"("team_uuid" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."is_user_on_team"("p_user_id" "uuid", "p_team_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."log_review_status_change"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."mark_player_stats_stale"("p_player_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."mark_task_reminder_sent"("p_task_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."recalculate_baseball_season_stats"("p_player_id" "uuid", "p_team_id" "uuid", "p_season_year" integer) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."recalculate_round_strokes_gained"("p_round_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."recalculate_team_baseball_season_stats"("p_team_id" "uuid", "p_season_year" integer) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."recompute_golf_round_totals"("p_round_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."refresh_crm_coach_engagement"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."refresh_player_standing"("p_team_ids" "uuid"[]) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."refresh_player_standing_round_metrics"("p_team_ids" "uuid"[]) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."refresh_player_stats_cache"("p_player_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."save_partial_round_atomic"("p_round_id" "uuid", "p_round_data" "jsonb", "p_holes" "jsonb", "p_shots" "jsonb", "p_putt_details" "jsonb", "p_approach_details" "jsonb", "p_expected_updated_at" timestamp with time zone) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."set_calendar_feed_token"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."set_document_version_number"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."sg_estimate_from_holes"("p_round_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."sg_expected_strokes"("p_lie" "text", "p_distance_yards" numeric) OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."sg_normalize_lie"("p_lie" "text") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."stop_sequences_on_reply"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."submit_round_atomic"("p_round_id" "uuid", "p_round_data" "jsonb", "p_holes" "jsonb", "p_shots" "jsonb", "p_putt_details" "jsonb", "p_approach_details" "jsonb") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."sync_coach_last_email_event"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."sync_email_snapshot_from_event"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."touch_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_crm_automations_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_crm_coaches_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_crm_events_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_crm_google_tokens_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_crm_notes_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_crm_segments_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_crm_sequences_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_crm_tasks_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_device_tokens_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_document_version_info"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_golf_expenses_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_golf_task_reminders_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_golf_task_templates_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_golf_team_join_requests_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_message_has_attachments"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_player_stats_cache"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
DECLARE
...
-- owner-stripped: ALTER FUNCTION "public"."update_player_stats_cache"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_player_stats_cache_enhanced"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
-- owner-stripped: ALTER FUNCTION "public"."update_player_stats_cache_enhanced"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_player_stats_complete"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_player_stats_strokes_gained"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public', 'pg_temp'
    AS $$
...
-- owner-stripped: ALTER FUNCTION "public"."update_player_stats_strokes_gained"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_player_stats_strokes_gained"("p_player_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_push_subscriptions_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_qualifier_leaderboard"("p_qualifier_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_round_stats_cache"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_round_stats_cache_with_sg"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
-- owner-stripped: ALTER FUNCTION "public"."update_round_stats_cache_with_sg"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_updated_at"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_updated_at_column"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."update_user_last_seen"("target_user_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."user_conversation_ids"("p_user_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."user_has_pending_join_request_to_coach_team"("check_player_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."user_is_coach_of_golf_player"("check_player_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."user_is_golf_team_member"("check_team_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."user_is_teammate_of_golf_player"("check_player_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."validate_notification_preferences"() OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."verify_coach_owns_player"("p_player_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."verify_coach_owns_team"("p_team_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";
...
-- owner-stripped: ALTER FUNCTION "public"."write_suppression_on_unsubscribe"() OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."admin_analytics_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."admin_api_perf_log" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."admin_client_errors" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."admin_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."api_call_logs" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."approach_miss_details" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."audit_log" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."auth_metrics_hourly" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."auth_rate_limits" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."background_job_logs" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_academic_eligibility" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_announcement_acknowledgements" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_announcement_recipients" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_announcements" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_box_score_batting" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_box_score_pitching" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_box_score_uploads" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_camp_registrations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_camps" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_coach_insights" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_coach_philosophy" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_coach_recruiting_philosophy" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_coaches" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_conversation_participants" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_conversations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_developmental_plans" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_document_versions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_documents" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_event_attendance" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_games" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_lineup_positions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_messages" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_notifications" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_player_aggregates" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_player_classes" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_player_comparisons" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_player_engagement_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_player_percentiles" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_player_season_stats" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_player_settings" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_player_stats" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_players" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_recruiting_interests" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_stat_uploads" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_task_assignments" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_task_templates" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_tasks" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_team_coach_staff" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_team_invitations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_team_lineups" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_team_members" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_teams" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_travel_expenses" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_travel_itineraries" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_videos" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."baseball_watchlists" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_activity_log" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_automations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_coaches" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_contact_log" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."email_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER MATERIALIZED VIEW "public"."crm_coach_engagement" OWNER TO "postgres";
...
-- owner-stripped: ALTER VIEW "public"."crm_email_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_email_suppressions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_email_templates" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_google_calendar_tokens" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_notes" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_replies" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_segments" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_sequence_enrollments" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_sequence_steps" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_sequences" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."crm_tasks" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."demo_requests" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."device_tokens" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."email_clicks" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."emails" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."error_logs" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."error_rate_hourly" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_academic_exclusions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_announcement_acknowledgements" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_announcement_documents" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_announcement_recipients" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_announcement_tasks" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_announcements" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_attendance_summary" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_calendar_feeds" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_calendar_notifications" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_causal_relationships" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coach_behavior_log" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coach_blocked_time" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coach_insights" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coach_philosophy" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coach_player_intent" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coaches" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coachhelm_chat_conversations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coachhelm_chat_messages" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coachhelm_coach_weights" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coachhelm_llm_budget" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coachhelm_llm_calls" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_coachhelm_settings" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_confidence_calibration" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_conversation_participants" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_conversations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_course_holes" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_courses" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_document_versions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_documents" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_drills" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_event_attendance" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_event_documents" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_global_patterns" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_goal_suggestions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_goals" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_holes" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_ingest_connections" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_ingest_sync_log" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_insight_drill_attachments" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_insight_effectiveness" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_insight_generation_log" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_insight_outcome_attribution" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_insight_player_feedback" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_learned_behavior" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_message_attachments" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_messages" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_metrics" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_patterns_v2" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."golf_percentile_cache" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "player_id" "uuid" NOT NULL,
...
-- owner-stripped: ALTER TABLE "public"."golf_percentile_cache" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_pga_standards" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_platform_metrics_daily" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."golf_player_attendance_stats" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "player_id" "uuid" NOT NULL,
    "team_id" "uuid" NOT NULL,
    "period_start" "date" NOT NULL,
...
-- owner-stripped: ALTER TABLE "public"."golf_player_attendance_stats" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."golf_player_baselines" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "player_id" "uuid" NOT NULL,
    "metric_name" "text" NOT NULL,
...
-- owner-stripped: ALTER TABLE "public"."golf_player_baselines" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_player_classes" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_player_courses" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_player_focus_areas" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_player_genome" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_player_notification_state" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_player_standing" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_player_stats_cache" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_players" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_practice_sessions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_prediction_model_performance" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_prediction_validations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_predictions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_qualifier_entries" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_qualifier_selections" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_qualifiers" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_recruits" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_review_events" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_round_reviews" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_round_stats_cache" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_rounds" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_shots" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_task_assignments" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_task_reminders" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_task_templates" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_tasks" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_team_coach_staff" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_team_coachhelm_settings" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_team_join_requests" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_team_members" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_team_settings" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_teams" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."golf_tracer_health_snapshot" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
-- owner-stripped: ALTER TABLE "public"."golf_tracer_health_snapshot" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_travel_budgets" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_travel_expenses" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."golf_travel_itineraries" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."golf_validations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "prediction_id" "uuid",
    "player_id" "uuid" NOT NULL,
...
-- owner-stripped: ALTER TABLE "public"."golf_validations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."login_attempts" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."notifications" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."organizations" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."push_subscriptions" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."putt_details" OWNER TO "postgres";
...
-- owner-stripped: ALTER TABLE "public"."users" OWNER TO "postgres";
...
GRANT ALL ON FUNCTION "public"."__admin_rollup_b_gate"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."__admin_rollup_b_gate"() TO "service_role";



GRANT ALL ON FUNCTION "public"."calculate_round_strokes_gained"("p_round_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."calculate_strokes_gained_on_round_complete"() TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_strokes_gained_on_round_complete"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_strokes_gained_on_round_complete"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."extract_email_click_from_event"() TO "anon";
GRANT ALL ON FUNCTION "public"."extract_email_click_from_event"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."get_admin_coachhelm_rollup"("p_ago7d" timestamp with time zone, "p_ago30d" timestamp with time zone, "p_ago12w" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_admin_event_summary"("p_days_back" integer) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_admin_feature_adoption_rollup"("p_ago30d" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_admin_rounds_rollup"("p_today" timestamp with time zone, "p_ago24h" timestamp with time zone, "p_ago7d" timestamp with time zone, "p_ago14d" timestamp with time zone, "p_ago30d" timestamp with time zone, "p_ago60d" timestamp with time zone, "p_ago12w" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_admin_users_rollup"("p_ago7d" timestamp with time zone, "p_ago14d" timestamp with time zone, "p_ago30d" timestamp with time zone, "p_ago12w" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_audit_log_recent"("limit_count" integer) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_baseball_conversations_with_details"("p_user_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_coach_effectiveness_metrics"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_coach_today_schedule"("p_team_id" "uuid", "p_today_start" timestamp with time zone, "p_today_end" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_crm_click_destinations"("p_window" "text", "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_crm_click_destinations"("p_window" "text", "p_limit" integer) TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."get_crm_email_stats"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_crm_events_in_range"("p_start" timestamp with time zone, "p_end" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_crm_template_performance"("p_window" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."get_crm_template_performance"("p_window" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_crm_template_performance"("p_window" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_crm_time_to_open"("p_window" "text") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_current_golf_player_id"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_current_player_team_ids"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_golf_conversations_with_details"("p_user_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_my_baseball_conversation_ids"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_my_coach_id"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_my_player_id"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_platform_health_stats"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_player_hub_announcements"("p_team_id" "uuid", "p_player_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_player_hub_events"("p_team_id" "uuid", "p_player_id" "uuid", "p_since" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_player_stats_summary"("p_player_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_qualifier_leaderboard"("qualifier_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_user_golf_organization_id"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."get_user_golf_team_ids"() TO "anon";
...
GRANT ALL ON FUNCTION "public"."golf_event_documents_assert_same_team"() TO "anon";
GRANT ALL ON FUNCTION "public"."golf_event_documents_assert_same_team"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."golf_event_documents_assert_same_team"() TO "service_role";



GRANT ALL ON FUNCTION "public"."golf_holes_recompute_round_totals_fn"() TO "anon";
GRANT ALL ON FUNCTION "public"."golf_holes_recompute_round_totals_fn"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."is_baseball_primary_coach"("p_team_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_baseball_team_coach"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_baseball_team_member"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_baseball_team_member_v2"("p_team_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_baseball_team_player"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_golf_team_coach"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_golf_team_player"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_golf_team_primary_coach"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_in_team"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_team_coach"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."is_team_player"("team_uuid" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."mark_player_stats_stale"("p_player_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."mark_player_stats_stale"("p_player_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."mark_player_stats_stale"("p_player_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."mark_task_reminder_sent"("p_task_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."mark_task_reminder_sent"("p_task_id" "uuid") TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."recompute_golf_round_totals"("p_round_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."refresh_crm_coach_engagement"() TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_crm_coach_engagement"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_crm_coach_engagement"() TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_player_standing"("p_team_ids" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_player_standing"("p_team_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_player_standing"("p_team_ids" "uuid"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_player_standing_round_metrics"("p_team_ids" "uuid"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_player_standing_round_metrics"("p_team_ids" "uuid"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_player_standing_round_metrics"("p_team_ids" "uuid"[]) TO "service_role";



GRANT ALL ON FUNCTION "public"."refresh_player_stats_cache"("p_player_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."refresh_player_stats_cache"("p_player_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."refresh_player_stats_cache"("p_player_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."save_partial_round_atomic"("p_round_id" "uuid", "p_round_data" "jsonb", "p_holes" "jsonb", "p_shots" "jsonb", "p_putt_details" "jsonb", "p_approach_details" "jsonb", "p_expected_updated_at" timestamp with time zone) TO "anon";
...
GRANT ALL ON FUNCTION "public"."set_calendar_feed_token"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_calendar_feed_token"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."submit_round_atomic"("p_round_id" "uuid", "p_round_data" "jsonb", "p_holes" "jsonb", "p_shots" "jsonb", "p_putt_details" "jsonb", "p_approach_details" "jsonb") TO "anon";
...
GRANT ALL ON FUNCTION "public"."sync_coach_last_email_event"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_coach_last_email_event"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."sync_coach_last_email_event"() TO "service_role";



GRANT ALL ON FUNCTION "public"."sync_email_snapshot_from_event"() TO "anon";
GRANT ALL ON FUNCTION "public"."sync_email_snapshot_from_event"() TO "authenticated";
...
GRANT ALL ON FUNCTION "public"."update_player_stats_cache"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_player_stats_cache"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_player_stats_cache"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_player_stats_cache_enhanced"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_player_stats_cache_enhanced"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_player_stats_cache_enhanced"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_player_stats_complete"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_player_stats_complete"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_player_stats_complete"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_player_stats_strokes_gained"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_player_stats_strokes_gained"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_player_stats_strokes_gained"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_round_stats_cache"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_round_stats_cache"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_round_stats_cache"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_round_stats_cache_with_sg"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_round_stats_cache_with_sg"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_round_stats_cache_with_sg"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_user_last_seen"("target_user_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."user_conversation_ids"("p_user_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."user_has_pending_join_request_to_coach_team"("check_player_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."user_is_coach_of_golf_player"("check_player_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."user_is_golf_team_member"("check_team_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."user_is_teammate_of_golf_player"("check_player_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."verify_coach_owns_player"("p_player_id" "uuid", "p_user_id" "uuid") TO "anon";
...
GRANT ALL ON FUNCTION "public"."verify_coach_owns_team"("p_team_id" "uuid", "p_user_id" "uuid") TO "anon";
...
GRANT ALL ON TABLE "public"."background_job_logs" TO "anon";
...
GRANT ALL ON TABLE "public"."baseball_academic_eligibility" TO "anon";
GRANT ALL ON TABLE "public"."baseball_academic_eligibility" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_academic_eligibility" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_announcement_acknowledgements" TO "anon";
GRANT ALL ON TABLE "public"."baseball_announcement_acknowledgements" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_announcement_acknowledgements" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_announcement_recipients" TO "anon";
GRANT ALL ON TABLE "public"."baseball_announcement_recipients" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_announcement_recipients" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_announcements" TO "anon";
GRANT ALL ON TABLE "public"."baseball_announcements" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_announcements" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_box_score_batting" TO "anon";
GRANT ALL ON TABLE "public"."baseball_box_score_batting" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_box_score_batting" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_box_score_pitching" TO "anon";
GRANT ALL ON TABLE "public"."baseball_box_score_pitching" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_box_score_pitching" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_box_score_uploads" TO "anon";
GRANT ALL ON TABLE "public"."baseball_box_score_uploads" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_box_score_uploads" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_camp_registrations" TO "anon";
GRANT ALL ON TABLE "public"."baseball_camp_registrations" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_camp_registrations" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_camps" TO "anon";
GRANT ALL ON TABLE "public"."baseball_camps" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_camps" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_coach_insights" TO "anon";
GRANT ALL ON TABLE "public"."baseball_coach_insights" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_coach_insights" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_coach_philosophy" TO "anon";
GRANT ALL ON TABLE "public"."baseball_coach_philosophy" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_coach_philosophy" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_coach_recruiting_philosophy" TO "anon";
GRANT ALL ON TABLE "public"."baseball_coach_recruiting_philosophy" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_coach_recruiting_philosophy" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_coaches" TO "anon";
GRANT ALL ON TABLE "public"."baseball_coaches" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_coaches" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_conversation_participants" TO "anon";
GRANT ALL ON TABLE "public"."baseball_conversation_participants" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_conversation_participants" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_conversations" TO "anon";
GRANT ALL ON TABLE "public"."baseball_conversations" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_conversations" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_developmental_plans" TO "anon";
GRANT ALL ON TABLE "public"."baseball_developmental_plans" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_developmental_plans" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_document_versions" TO "anon";
GRANT ALL ON TABLE "public"."baseball_document_versions" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_document_versions" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_documents" TO "anon";
GRANT ALL ON TABLE "public"."baseball_documents" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_documents" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_event_attendance" TO "anon";
GRANT ALL ON TABLE "public"."baseball_event_attendance" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_event_attendance" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_events" TO "anon";
GRANT ALL ON TABLE "public"."baseball_events" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_events" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_games" TO "anon";
GRANT ALL ON TABLE "public"."baseball_games" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_games" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_lineup_positions" TO "anon";
GRANT ALL ON TABLE "public"."baseball_lineup_positions" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_lineup_positions" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_messages" TO "anon";
GRANT ALL ON TABLE "public"."baseball_messages" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_messages" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_notifications" TO "anon";
GRANT ALL ON TABLE "public"."baseball_notifications" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_notifications" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_player_aggregates" TO "anon";
GRANT ALL ON TABLE "public"."baseball_player_aggregates" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_player_aggregates" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_player_classes" TO "anon";
GRANT ALL ON TABLE "public"."baseball_player_classes" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_player_classes" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_player_comparisons" TO "anon";
GRANT ALL ON TABLE "public"."baseball_player_comparisons" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_player_comparisons" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_player_engagement_events" TO "anon";
GRANT ALL ON TABLE "public"."baseball_player_engagement_events" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_player_engagement_events" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_player_percentiles" TO "anon";
GRANT ALL ON TABLE "public"."baseball_player_percentiles" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_player_percentiles" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_player_season_stats" TO "anon";
GRANT ALL ON TABLE "public"."baseball_player_season_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_player_season_stats" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_player_settings" TO "anon";
GRANT ALL ON TABLE "public"."baseball_player_settings" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_player_settings" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_player_stats" TO "anon";
GRANT ALL ON TABLE "public"."baseball_player_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_player_stats" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_players" TO "anon";
GRANT ALL ON TABLE "public"."baseball_players" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_players" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_recruiting_interests" TO "anon";
GRANT ALL ON TABLE "public"."baseball_recruiting_interests" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_recruiting_interests" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_stat_uploads" TO "anon";
GRANT ALL ON TABLE "public"."baseball_stat_uploads" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_stat_uploads" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_task_assignments" TO "anon";
GRANT ALL ON TABLE "public"."baseball_task_assignments" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_task_assignments" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_task_templates" TO "anon";
GRANT ALL ON TABLE "public"."baseball_task_templates" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_task_templates" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_tasks" TO "anon";
GRANT ALL ON TABLE "public"."baseball_tasks" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_tasks" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_team_coach_staff" TO "anon";
GRANT ALL ON TABLE "public"."baseball_team_coach_staff" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_team_coach_staff" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_team_invitations" TO "anon";
GRANT ALL ON TABLE "public"."baseball_team_invitations" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_team_invitations" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_team_lineups" TO "anon";
GRANT ALL ON TABLE "public"."baseball_team_lineups" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_team_lineups" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_team_members" TO "anon";
GRANT ALL ON TABLE "public"."baseball_team_members" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_team_members" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_teams" TO "anon";
GRANT ALL ON TABLE "public"."baseball_teams" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_teams" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_travel_expenses" TO "anon";
GRANT ALL ON TABLE "public"."baseball_travel_expenses" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_travel_expenses" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_travel_itineraries" TO "anon";
GRANT ALL ON TABLE "public"."baseball_travel_itineraries" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_travel_itineraries" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_videos" TO "anon";
GRANT ALL ON TABLE "public"."baseball_videos" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_videos" TO "service_role";



GRANT ALL ON TABLE "public"."baseball_watchlists" TO "anon";
GRANT ALL ON TABLE "public"."baseball_watchlists" TO "authenticated";
GRANT ALL ON TABLE "public"."baseball_watchlists" TO "service_role";
...
GRANT ALL ON TABLE "public"."crm_coaches" TO "anon";
...
GRANT ALL ON TABLE "public"."crm_coach_engagement" TO "anon";
GRANT ALL ON TABLE "public"."crm_coach_engagement" TO "authenticated";
...
GRANT ALL ON TABLE "public"."golf_calendar_feeds" TO "anon";
GRANT ALL ON TABLE "public"."golf_calendar_feeds" TO "authenticated";
GRANT ALL ON TABLE "public"."golf_calendar_feeds" TO "service_role";



GRANT ALL ON TABLE "public"."golf_calendar_notifications" TO "anon";
GRANT ALL ON TABLE "public"."golf_calendar_notifications" TO "authenticated";
...
GRANT ALL ON TABLE "public"."golf_coachhelm_chat_conversations" TO "anon";
GRANT ALL ON TABLE "public"."golf_coachhelm_chat_conversations" TO "authenticated";
GRANT ALL ON TABLE "public"."golf_coachhelm_chat_conversations" TO "service_role";



GRANT ALL ON TABLE "public"."golf_coachhelm_chat_messages" TO "anon";
GRANT ALL ON TABLE "public"."golf_coachhelm_chat_messages" TO "authenticated";
...
GRANT ALL ON TABLE "public"."golf_event_documents" TO "anon";
GRANT ALL ON TABLE "public"."golf_event_documents" TO "authenticated";
...
GRANT ALL ON TABLE "public"."golf_patterns_v2" TO "anon";
GRANT ALL ON TABLE "public"."golf_patterns_v2" TO "authenticated";
GRANT ALL ON TABLE "public"."golf_patterns_v2" TO "service_role";



GRANT ALL ON TABLE "public"."golf_percentile_cache" TO "anon";
GRANT ALL ON TABLE "public"."golf_percentile_cache" TO "authenticated";
GRANT ALL ON TABLE "public"."golf_percentile_cache" TO "service_role";
...
GRANT ALL ON TABLE "public"."golf_player_attendance_stats" TO "anon";
GRANT ALL ON TABLE "public"."golf_player_attendance_stats" TO "authenticated";
GRANT ALL ON TABLE "public"."golf_player_attendance_stats" TO "service_role";



GRANT ALL ON TABLE "public"."golf_player_baselines" TO "anon";
GRANT ALL ON TABLE "public"."golf_player_baselines" TO "authenticated";
GRANT ALL ON TABLE "public"."golf_player_baselines" TO "service_role";
...
GRANT ALL ON TABLE "public"."golf_round_reviews" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."golf_round_reviews" TO "authenticated";
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,MAINTAIN ON TABLE "public"."golf_rounds" TO "authenticated";
...
GRANT ALL ON TABLE "public"."golf_tracer_health_snapshot" TO "anon";
GRANT ALL ON TABLE "public"."golf_tracer_health_snapshot" TO "authenticated";
GRANT ALL ON TABLE "public"."golf_tracer_health_snapshot" TO "service_role";
...
GRANT ALL ON TABLE "public"."golf_validations" TO "anon";
GRANT ALL ON TABLE "public"."golf_validations" TO "authenticated";
GRANT ALL ON TABLE "public"."golf_validations" TO "service_role";
