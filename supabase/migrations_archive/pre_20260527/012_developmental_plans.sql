-- ============================================================================
-- Migration: 012_developmental_plans.sql
-- Purpose: Developmental plans created by coaches for players
-- Consolidated from: 009_create_developmental_plans.sql
-- ============================================================================
...
CREATE TRIGGER set_dev_plan_sent_timestamp
  BEFORE UPDATE ON developmental_plans
  FOR EACH ROW EXECUTE FUNCTION set_dev_plan_sent_at();

-- Helper function: Get active dev plans for a player
