...
CREATE INDEX "golf_focus_area_criteria_player_id_idx" ON "public"."golf_focus_area_criteria" USING "btree" ("player_id");
...
CREATE INDEX "golf_focus_area_practice_sessions_player_id_idx" ON "public"."golf_focus_area_practice_sessions" USING "btree" ("player_id");
