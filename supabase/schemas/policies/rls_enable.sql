ALTER TABLE ONLY "public"."admin_allowlist" FORCE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."backup_ci_junk_rounds_20260821" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."backup_class_semester_20260813" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."backup_prevyear_classes_20260821" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."baseball_coach_notes" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."baseball_event_acknowledgements" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."baseball_import_runs" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."baseball_player_daily_contracts" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."baseball_player_external_ids" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."baseball_player_passport_settings" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."baseball_player_passport_share_tokens" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."baseball_player_timeline_events" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."baseball_practice_lineup_slots" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."baseball_practice_scrimmages" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."crm_email_templates_backup_20260720" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."golf_insight_action" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."golf_insight_exposure" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."golf_insight_generation_log" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."golf_insight_outcome" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."schema_migrations_pruned_20260820" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."users" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_availability_statuses" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_bodyweight_entries" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_import_field_mappings" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_assignments" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_days" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_exercise_substitutions" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_exercises" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_import_rows" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_import_runs" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_prescriptions" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_program_assignments" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_programs" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_results" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_sections" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_session_exercises" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_sessions" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_set_results" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_lift_weeks" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_readiness_checkins" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_soreness_maps" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_stat_facts" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_strength_group_audit" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_strength_group_members" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_strength_groups" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_strength_maxes" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."baseball_strength_prs" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."crm_activity_log" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."golf_percentile_cache" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."golf_player_attendance_stats" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "graveyard"."golf_player_baselines" ENABLE ROW LEVEL SECURITY;
