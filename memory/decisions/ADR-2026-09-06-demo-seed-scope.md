...
`docs/archive/2026-07/baseballhelm-overnight/baseballhelm-overnight/DECISION_LOG.md`
...
script as safe. The historical log this ADR draws from moved to
`docs/archive/2026-07/` as part of the 2026-09 docs lifecycle sweep; this ADR
is the durable record of the one entry from it worth carrying forward.
