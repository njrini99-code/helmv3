...
**266 tables, 3998 columns** — generated from `src/lib/types/database.ts`, which `npm run db:types` regenerates from the live database. Types shown are the TypeScript Row types; `| null` marks a nullable column.
...
<details><summary><code>golf_player_focus_areas</code> — 25 columns</summary>
...
<details><summary><code>golf_tasks</code> — 17 columns</summary>
