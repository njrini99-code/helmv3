...
**276 tables, 4124 columns** — generated from `src/lib/types/database.ts`, which `npm run db:types` regenerates from the live database. Types shown are the TypeScript Row types; `| null` marks a nullable column.
