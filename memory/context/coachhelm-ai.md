...
| ~~`SectionBand` (inside `FingerprintHero.tsx`)~~ | REMOVED 2026-09-22 | Was dead (zero importers); `MetricPill` moved to `game/print/MetricPill.tsx`, file deleted 2026-09-24 (DS-04) |
