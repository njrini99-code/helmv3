...
**235 routes** (source: `src/app/**/page.tsx`).
...
- `/golf/dashboard/players/[playerId]/genome`
...
**211 server-action files** (source: `src/app/**/actions/**/*.ts`).
...
- `src/app/admin/actions/analyze-error.ts`
- `src/app/admin/actions/billing.ts`
- `src/app/admin/actions/golf-tracer.ts`
- `src/app/admin/actions/resolve-error.ts`
- `src/app/admin/actions/sentry-resolve.ts`
...
- `src/app/golf/actions/admin/demo-teams.ts`
...
- `src/app/golf/actions/class-detail.ts`
- `src/app/golf/actions/coach-entry.ts`
...
- `src/app/golf/actions/conflict-inbox.ts`
...
- `src/app/golf/actions/crm-demo-sessions.ts`
...
- `src/app/golf/actions/crm-intent.ts`
- `src/app/golf/actions/crm-kpis.ts`
- `src/app/golf/actions/crm-manual-send.ts`
- `src/app/golf/actions/crm-replies.ts`
- `src/app/golf/actions/crm-sequences.ts`
- `src/app/golf/actions/crm-signals.ts`
- `src/app/golf/actions/crm-stage-ages.ts`
- `src/app/golf/actions/crm-stage-history.ts`
...
- `src/app/golf/actions/notification-badges-types.ts`
- `src/app/golf/actions/notification-badges.ts`
...
- `src/app/golf/actions/round-review-narrative.ts`
...
- `src/app/golf/actions/schedule-image.ts`
- `src/app/golf/actions/scheduling.ts`
- `src/app/golf/actions/shot-analytics.ts`
- `src/app/golf/actions/signal-groups.ts`
- `src/app/golf/actions/stats-dashboard.ts`
...
- `src/app/golf/actions/unified-notifications-model.ts`
- `src/app/golf/actions/unified-notifications.ts`
...
**54 custom hooks** (source: `src/hooks/**/*.ts`).
...
- `src/hooks/golf/use-conflict-inbox.ts`
...
- `src/hooks/use-immersive-surface.ts`
