...
Inner loop: `npm run test:file -- <paths>` and `npm run typecheck:fast`. A
full pass takes several minutes, longer than a foreground Bash call allows:
run it in the background to a log file and read the file.
