...
export const SURFACE_COVERAGE: readonly CoverageEntry[] = [
  ...
  { table: 'baseball_strength_groups', route: '/baseball/dashboard/performance/groups', scopeColumn: 'team_id', required: true },
  { table: 'baseball_strength_group_members', route: '/baseball/dashboard/performance/groups', scopeColumn: 'none', required: true, note: 'scoped via group_id; counted globally since the table has no team_id column' },
