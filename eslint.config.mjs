    ...
    rules: {
      "no-restricted-imports": ["error", {
        ...
        patterns: [
          ...
          { group: ["./three-*", "./shadow-bounds", "./terrain-canopy", "./terrain-material", "./terrain-viewport", "./shot-overlay-*", "./runtime-controller", "./camera-motion", "./visual-style", "./visual-artifact", "./visual-artifact-v2"],
