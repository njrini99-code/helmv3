...
COMMENT ON FUNCTION "public"."handle_new_user"() IS 'Creates user profile records when auth.users record is created.
...
CREATE POLICY "Authenticated users can create teams" ON "public"."golf_teams" FOR INSERT TO "authenticated" WITH CHECK (true);
